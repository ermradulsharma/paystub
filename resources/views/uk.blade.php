                    ...
                    <div class="col-lg-6  col-md-12 mt-3 text-center2">
                        ...
                        <div class="mt-5 pt-3 d-flex uk-goo" style="padding: 25px 49px; ">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.paystubx" target="_blank"><img
                                    class="storbtn ml-3" src="{{ asset('images/Google_Play_Store_badge_EN.webp') }}"></a>
    ...
    <div class="container" style="max-width:1613px;">
        <div class="row">
            <div class="col-lg-10 mt-3">
                ...
                <p class="ukp1">Your payslip must show the total amount you’ve earned. Sometimes, your employer breaks
                    this
                    down
                    into
                    categories, such as:
