        ...
        <div class="row pb-5">
            <div class="col-lg-6 col-md-4 banner-left-content payhead col-set">
                ...
                <div class="mt-5 pt-5 justify-content-center ">
                    <a class="btn btn-lg  mt-5 p-2 btn-danger Generate " href="{{route('usa.payStub')}}">Generate Paystub Now</a>
                </div>
...
<div class="container pt-5 wrapper">
    ...
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="paytext">
                <p style="" class="smallfont1">TAX FILING HAS NEVER BEEN EASY </p>
                <p class="text-black text-capitalize smallfont2" style="">Handling Payroll Yourself? </p>
                <p class="text-danger smallfont3" style="">You are at the right place! </p>
                <div class="mt-3 gennn">
                    <a class="btn btn-lg  mt-2 p-2 btn-danger Generate " href="{{route('usa.payStub')}}">Generate Paystub Now</a>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
            ...
            <div class="payyy">
                <p class="img2-p"> On Paystub X Join thousands of satisfied independent </br> contractors and small business owners and get the </br> highest quality pay stubs, W2s and 1099s — right to </br> your inbox! We make it easy. Guaranteed.</p>
            </div>
        </div>
    ...
    <div class="container " style="max-width: 1750px;">
        <div class="">
            <div class="text-justify text-center pb-5">
                <h2 style="font-size:30px; font-family: 'Futura LT';" class="text-white pt-5 gen"> Generate paystubs with accurate tax calculations, W-2, 1099S Etc in Seconds</h2>
                <div class="row mt-5">
                    <div class="col-md-4 mt-3 text-center">
                        <h2 class="text-white calcheading head-font" style="">Add your Data </h2>
                        <p style="font-size:17px;font-weight: 200;font-family: 'Futura LT';line-height:1.8;" class="text-white pay-p head-font">Our paystub generator accurately</br> calculates your Federal and State</br> taxes, including Social security </br>and Medicare taxes so you don't </p>
                    ...
                    <div class="col-md-4 mt-3 text-center">
                        <h2 class="text-white calcheading head-font" style="">Preview Data </h2>
                        <p style="font-size:17px;font-weight: 200;font-family: 'Futura LT'; line-height:1.8;" class="text-white pay-p head-font">Generate pay stubs with accurate</br> state income taxes, based on </br>state W-4, and other applicable</br> local taxes. </p>
                    ...
                    <div class="col-md-4 mt-3 text-center">
                        ...
                        <p style="font-size:17px;font-weight: 200;font-family: 'Futura LT'; line-height:1.8;" class="text-white pay-p head-font">You will get to generate unlimited</br> payslip, paycheck or paystub </br>according to the plan you select. </p>
...
<div>
    <div class="container text-justify text-center pb-5">
        <h1 style="font-size:30px;font-family: font-family: 'Futura'; font-weight:600;" class="pt-5">Why do Small Businesses Love Paystub<span class="text-danger">X?</span></h1>
    </div>
    ...
    <div class="container" style="max-width:1800px">
        <div class="row">
            ...
            <div class="col-md-6 text-left mb-5">
                <div class="mt-5 ready" style="font-size: 32px; font-family: 'Futura LT'; font-weight:600;"> Ready to Explore our Online Paystub Generator?  </div>
                <div>
                    <ul class="list-outer">
                        <li class="mt-2" style="font-weight: 200; font-size: 20px; line-height:1.5em; font-family: 'Futura LT';"> W-2 - Efile with SSA, Distribute to Employees. ✅</li>
                        <li class="mt-2" style="font-weight: 200; font-size: 20px; line-height:1.5em; font-family: 'Futura LT';"> 1099-NEC, 1099-MISC - Efile with IRS, Distribute to Contractors ✅</li>
                ...
                <div class="mt-5 pt-3  ">
                    <a class="btn btn-lg  btn-danger Generate " href="{{route('usa.payStub')}}">Generate Paystub Now</a>
                </div>
            </div>

            <div class="col-md-5 text-left mb-5 ">
                <div class="mt-5">
                    <b style="font-size: 24px; font-weight: 600; font-family: 'Futura LT';"> Generate Paystubs Using our<span class="text-danger"> Android or iOS App</span></b>
                    <p style="font-size: 20px;line-height: 35px;font-family: 'Futura LT';" class="mt-1 ">Generate paystubs instantly by using our paystub generator app.</br> It's simple, easy, and accurate.</p>
                </div>
