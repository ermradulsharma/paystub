...
<head>
    ...
    <meta name="google-signin-client_id" content="761072364779-1r5uld555knefccdmuens9ar0anfp58g.apps.googleusercontent.com">
...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="google-btn mt-4">
                        ...
                        <a class="btn-text pr-1" href="{{ route('login.google') }}"
                            style="text-transform:capitalize;">Sign up with google</a>
                    </div>
    ...
    <div class="g-signin2" data-longtitle="true" data-onsuccess="Google_signIn" data-theme="light"
        data-width="200"></div>
