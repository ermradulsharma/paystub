...
<body>
            ...
            <li class="nav-item d-flex justify-content-center  " style="">
                @guest
                    ...
                    <div class="dropdown d-none logoutDiv">
                        <button onclick="myFunction()" class="dropbtn"> Hi {{ Auth::user()->first_name ?? '' }}
                    ...
                    <div class="logout d-none logoutDiv">
                        <a class="btn-logout" href="javascript:void(0);">
                            <img style="width: 22px;" src="{{ asset('images/logout01.png') }}">
                        </a>
                    </div>
                @endguest
                ...
                @auth
                    <div class="container">
                        <div class="user-icon" style="">
                            <img style="width: 44px;" src="{{ asset('images/profile1.png') }}">
                        </div>
                        <div class="dropbtn">
                            <button class="btn btn-default dropdown-toggle navright-btn" type="button" id="menu1" data-toggle="dropdown">Hi {{ Auth::user()->first_name ?? '' }}<span class="caret"></span></button>
                    ...
                    <div class="logout">
                        <a class="btn-logout" href="javascript:void(0);">
                            <img style="width: 40px;" src="{{ asset('images/logout01.png') }}">
                        </a>
                    </div>
                @endauth
            </li>
    ...
    <div class="openbtn">
        <div class=" pt-4 d-flex justify-content-between" style="display:flex !important">
            <a href="{{ url('/') }}">
                <img class="mr-3 mt-5 toggle-logo" src="{{ asset('images/Paystub X.webp') }}" style="width: 222px;">
            </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="google-btn mt-4" style="text-align: -webkit-center; text-align: -moz-center;">
                        <div id="g_id_onload" data-client_id="802702825376-57405b5o70d0l41mkh9q8ta86ig71rkb.apps.googleusercontent.com" data-callback="handleCredentialResponse" data-dismiss="modal" data-ux_mode="popup" data-auto_prompt="false"></div>
