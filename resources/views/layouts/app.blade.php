            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="google-btn mt-4">
                        ...
                        <a class="btn-text pr-1" href="{{ route('login.google') }}" style="text-transform:capitalize;">Sign up with google</a>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class=" text-center mt-4">
                        ...
                        <p style="color: #02030359;font-size: 14px;font-family: serif; text-transform:capitalize;" class="text-center">Enter the
