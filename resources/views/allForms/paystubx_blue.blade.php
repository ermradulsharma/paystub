    ...
    <div style="max-width: 100%; margin: auto; padding: 0px 20px;">
        ...
        <table style="width:100%; border-top:none;">
            ...
            <thead style="border-top:none; border-left:2px solid#464646;height:35px;">
                <th class="padding" colspan="2" style="text-align: center; color:black;"> {{ $requestData['emp_name'] }} </th>
            ...
            <tr>
                <td class="padding" id="colsborder" colspan="2" style="border:2px solid  #464646; text-align:center; border-top:none; border-bottom:none; padding:8px 0px !important;"> {{ $requestData['emp_id'] }}</td>
        ...
        <section style="border: 1px solid black;">
                    ...
                    <table class="colortable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">{{ $requestData['currency'] }} {{ number_format($requestData['total'][$key], 2) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
            ...
            <div class="ytd_total">
                <table id="bottomtable" style="width:100%; background-color:white; height:100px;">
                    <tr class="">
