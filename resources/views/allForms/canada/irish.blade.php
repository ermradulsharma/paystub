...
<body>
    ...
    @endauth
        <div style="max-width: 100%; margin: auto; padding: 10px 10px;">
            ...
            <section>
                <div class="row"
                    style=" background-color:#d9c6e6; border-left:2px solid #8a898a;border-right:3px solid#8a898a;">
                    <div class="column1">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                ...
                                <th class="padding" style="font-size:13px;border-right:3px solid#9558bf;">CURRENT TOTAL</th>
                            </thead>
                            <tbody style="">
                    ...
                    <div class="column2">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                <th class="padding" style="text-align: left;padding-left:15px;font-size:13px;border-left:3px solid #9558bf; ">DEDUCTIONS</th>
