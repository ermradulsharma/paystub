...
<body>
    <main class="bg-img2">
        ...
        <div style="max-width: 100%; margin: auto; padding: 10px 10px;">
            ...
            <section>
                <div class="row"
                    style=" background-color:#c8e7c6; border-left:2px solid #8a898a;border-right:3px solid#8a898a;">
                    <div class="column1">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                ...
                                <th class="padding" style="font-size:14px;border-right:3px solid#60bf57;">CURRENT TOTAL</th>
                            </thead>
                            <tbody style="">
