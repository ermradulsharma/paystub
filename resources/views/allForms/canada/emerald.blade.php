        ...
        <div style="max-width: 100%; margin: auto; padding: 10px 10px;">
            ...
            <table style="width:100%; border-left:3px solid#8a898a; border-right:3px solid#8a898a;">
                ...
                <tr>
                    ...
                    <td class="padding" colspan="2" style="border:3px solid #8a898a; text-align:center;border-top:none; border-bottom:none;font-size:14px;">{{ $requestData['check_number'] }}</td>
                </tr>
            </table>
            <section>
                <div class="row"
