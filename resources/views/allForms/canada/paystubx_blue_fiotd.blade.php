...
<body>
    <main class="bg-img2">
        ...
        <div style="max-width: 100%; margin: auto; padding: 10px 10px;">
            <table style="width:100%; border-left:3px solid #4a4a4a; border-right:3px solid #4a4a4a;background-color:darkgray;color:white;">
                <tr>
                    ...
                    <td
                        style="font-size: 18px;padding:10px 12px 8px 10px;text-transform:uppercase;font-weight:bold;">
                        Earnings Statement</td>
                </tr>
            </table>
            <table style="width:100%; border-left:3px solid #4a4a4a; border-right:3px solid #4a4a4a;">
                <thead style="border-top:none; border-left:2px solid #4a4a4a;height:35px;">
                    <th class="padding" colspan="2" style="text-align: left; padding-left:20px; color:black;font-size:16px;">
                        {{ $requestData['emp_name'] }}
                    </th>
                    <td class="padding" colspan="6" style="text-align: left; border-right:3px solid #4a4a4a;font-size:16px;">
                ...
                <tr>
                    <td class="padding" id="colsborder" colspan="2"
                        style="border:3px solid #4a4a4a; text-align: left; padding-left:20px; border-top:none; text-transform:capitalize; border-bottom:none;font-size:14px;">
                        {{ $requestData['emp_id'] }}
                    </td>
                    <td class="padding"
                        style="border:3px solid #4a4a4a; text-align:center; border-top:none; border-bottom:none;font-size:14px;"
                    ...
                    <td class="padding" colspan="2"
                        style="border:3px solid #4a4a4a; text-align:center;border-top:none; border-bottom:none;font-size:14px;">254236
                    </td>
                </tr>
            </table>
            <section>
                <div class="row"
                    style=" background-color:#dce6f1; border-left:2px solid #4a4a4a;border-right:3px solid#4a4a4a;">
                    <div class="column1">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                ...
                                <th class="padding" style="font-size:14px;border-right:3px solid#264fab;">CURRENT TOTAL</th>
                            </thead>
                            <tbody style="">
                                @foreach ($requestData['earning'] as $key => $earn)
                                    <tr style="">
                                        <td id="fica" style="padding:left 20px;font-size:14px;"> {{ $earn }}</td>
                                        <td style="font-size:14px;"> {{ number_format($requestData['rate'][$key], 2) }}</td>
                                        <td style="text-align: center;font-size:14px;">{{ $requestData['hours'][$key] }}.00</td>
                                        <td style="text-align: center;font-size:14px; ">{{ $requestData['currency'] }}
                    ...
                    <div class="column2">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                <th class="padding" style="text-align: center;font-size:14px;border-left:3px solid #264fab; ">DEDUCTION</th>
                                <th class="padding" style="font-size:14px;">CURRENT TOTAL</th>
                                <th class="padding" style="font-size:14px;">YEAR TO DATE</th>
                            </thead>
                            <tbody id="" style=" border-left:3px solid #4a4a4a;font-size:14px;">
                                ...
                                @foreach ($requestData['tax_deduction'] ?? [] as $key => $tax_deduction)
                                    <tr>
                                        <td id="fica" style="padding:left 10px;font-size:14px;">{{ $tax_deduction }}</td>
                                        <td style="text-align: center;font-size:14px;">{{ $requestData['currency'] }}
                ...
                <div class="row" style=" border:3px solid #4a4a4a; ">
                    <div class="column1">
                    ...
                    <div class="column2">
                        <table id="bottomtable" style="width:100%; background-color:white;">
                            <tr class="">
                                ...
                                <th id="cols" class="head1" style="border-right: none !im#4a4a4a; ">NET PAY
                                </th>
                            </tr>
                            <tr class=" ytd">
                                <td id="cols" class="head2">
                                ...
                                <td id="cols" class="head2" style="border-right: none !im#4a4a4a;">
