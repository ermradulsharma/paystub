            ...
            <table style="width:100%; border-left:3px solid #4a4a4a; border-right:3px solid #4a4a4a;">
                ...
                <tr>
                    <td class="padding" id="colsborder" colspan="2"
                        style="border:3px solid #4a4a4a; text-align: left; padding-left:20px; border-top:none; text-transform:capitalize; border-bottom:none;font-size:15px;">
                        {{ $requestData['emp_id'] }}
                    </td>
                    <td class="padding"
                        style="border:3px solid #4a4a4a; text-align:center; border-top:none; border-bottom:none;font-size:15px;"
                    ...
                    <td class="padding" colspan="2"
                        style="border:3px solid #4a4a4a; text-align:center;border-top:none; border-bottom:none;font-size:15px;">254236
                    </td>
                </tr>
            </table>
            <section>
                <div class="row"
                    ...
                    <div class="column2">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                <th class="padding" style="text-align: center;font-size:13px;border-left:3px solid #264fab; ">DEDUCTION</th>
                                <th class="padding" style="font-size:13px;">CURRENT TOTAL</th>
                                <th class="padding" style="font-size:13px;">YEAR TO DATE</th>
                            </thead>
                            <tbody id="" style=" border-left:3px solid #4a4a4a;font-size:15px;">
