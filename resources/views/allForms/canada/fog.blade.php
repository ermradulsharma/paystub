            ...
            <section>
                <div class="row"
                    ...
                    <div class="column1">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                ...
                                <th class="padding" style="font-size:14px;border-right:3px soliddarkgrey;">CURRENT TOTAL</th>
                            </thead>
                            <tbody style="">
                    ...
                    <div class="column2">
                        <table class="colortable" style="width:100%;">
                            <thead id="colourborder">
                                <th class="padding" style="text-align: center;font-size:14px;border-left:3px solid darkgrey; ">DEDUCTION</th>
