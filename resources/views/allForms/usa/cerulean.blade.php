                    ...
                    <table>
                        ...
                        @foreach ($requestData['earning'] as $key => $earn)
                            <tr>
                                ...
                                <td id="color" style="font-size:13px color:#000;">@if ($requestData['rate'][$key] != 0.0)<span style="font-family: 'DejaVu Sans', sans-serif; padding-right:1px;">{{ $requestData['currency'] }}</span> {{ number_format($requestData['rate'][$key], 2)}} @endif</td>
