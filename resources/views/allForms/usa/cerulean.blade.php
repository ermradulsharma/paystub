                    ...
                    <table>
                        ...
                        @foreach ($requestData['earning'] as $key => $earn)
                            <tr>
                                ...
                                <td id="color" style="font-size:13px color:#000;">@if ($requestData['rate'][$key] != 0.0)<span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span>{{ number_format($requestData['rate'][$key], 2)}} @endif</td>
                        ...
                        @foreach ($requestData['taxes'] ?? [] as $key => $taxes)
                            ...
                            @endforeach @if (count($requestData['tax_deduction'] ?? []) > 0)
                                ...
                                @foreach ($requestData['tax_deduction'] ?? [] as $key => $tax_deduction)
                                    <tr>
                                        <td></td>
                                        <td style="text-transform:capitalize;font-size:16px;" class="data" id="color">{{ $tax_deduction }}</td>
                                        <td id="color" class="alignR"
                                        style="font-size:16px; font-family: Arial, Helvetica, sans-serif; color:#000;">
