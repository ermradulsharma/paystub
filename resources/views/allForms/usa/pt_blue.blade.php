    ...
    <main class="bg-img2">
        ...
        <table class="top">
            ...
            <tr>
                ...
                <td style="border-right: 1px solid #afaec5; border-left: 1px solid #afaec5;"> {{ $requestData['cname'] }}
                </td>
        ...
        <section>
            ...
            <div class="row roww">
                <div class="col1">
                    <table style="width: 100%;border-right: 1px solid #afaec5;">
                        <thead style="border-top:0;" id="backcolor">
