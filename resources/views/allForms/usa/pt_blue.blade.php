    ...
    <div class="container" style="border-right: 1px solid   #43407A; margin: auto;border-top: 1px solid   #43407A; border-left: 1px solid   #43407A; border-bottom:none;padding: 0 0px 0px 0px;">
        <div class="row" style="display: flex; display: flex;justify-content: space-between;padding: 0px 14px;">
            <div style="width: 60%;float:left;">
                ...
                <p style="font-size: 13px; margin: 0;"> {{ $requestData['address_1'] }}
        ...
        <div style="width: 90%; display: flex; justify-content: flex-end;justify-content: space-between;margin: 30px auto 0px;font-size: 15px; font-weight: 900;padding: 0 20px;">
            <span>Pay to: <b>Ezra Moore</b></span>
            <span style="margin: 0; float:right;">Amount</span>


            <span style="margin: 0; float:right; padding-left:13px; margin-right: 11px;">Transit ABA</span>


            <span style="margin: 0; float:right;padding-left:13px; margin-right: 11px;">Account Number</span>
        ...
        <div style="width: 50%; display: flex; justify-content: flex-end;justify-content: space-between; FONT-SIZE: 17px; margin: 0px 0 0 151px;">
            <div style="margin-bottom: 19px;">
                ...
                <P style="margin: 0px 0 0 0; font-size:  12px;">282 65 AVE</P>
                <p style="margin: 0px 0 0 0;font-size: 12px;">{{ $requestData['address_1'] }}
                    </br>{{ $requestData['city'] }}
                    {{ $requestData['state'] }},
                    {{ $requestData['zip_code'] }}
                </p>
