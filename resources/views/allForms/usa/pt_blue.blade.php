...
<body>
    <main class="bg-img2">
        ...
        <div class="container"
            ...
            <div class="row" style="display: flex; display: flex;justify-content: space-between;padding: 0px 14px;">
                <div style="width: 60%;float:left;">
                    <h6 style="font-size: 15px; margin-bottom: 0;text-transform:capitalize;">
                        {{ $requestData['cname'] }}</h6>
                ...
                <div style="width:40%;float:right;">
                    ...
                    <br>
                    <P
                        style="font-size: 14px;margin: 0; text-align:right; padding-right:12%;font-weight:bold;font-family: Arial, Helvetica, sans-serif;">
                        <span style="font-weight:bold;padding-right:17px;">Check No:</span>
                        {{ $requestData['check_no'] ?? '' }} </P>
                    <P
                        style="font-size: 14px;margin: 0;  text-align:left; padding-left:109px;  margin-top:10px;font-family: Arial, Helvetica, sans-serif;font-weight:bold;">
                        <span style=" padding-left:10px;">Date:</span><b
                            style="padding-left:30px;">{{ date('m/d/y', strtotime($requestData['pay_date'])) }}</b> </P>
                </div>
            </div>
            <div style="padding-top:30px;">
                <table style="">
                    <tr style="border-right:none; border-left:none; border-top:none;">
                        <td style="text-transform:capitalize; font-size:13px; padding-left:15px; "><span
                                style="font-family: 'Arial Rounded MT Bold', sans-serif;font-weight:bold;">Pay
                                To:</span><b style="text-transform:uppercase; padding-left:10px;font-size:14px;">
                        ...
                        <td style="text-transform:capitalize; font-size:13px; padding-left:8px;font-weight:bold;">Amount
                        </td>
                    </tr>
                    <tr style="border-right:none; border-left:none; border-bottom:none;">
                        <td></td>
                        <td style="text-transform:capitalize; font-size:15px;padding-left:5px;">
                            XXXXXX{{ $requestData['account_number_last_4'] }}</td>
                        <td style="text-transform:capitalize; font-size:15px;">
                            XXXXX{{ $requestData['transit_aba_number'] }}</td>
                        <td style="text-transform:capitalize; font-size:17px; font-weight:bold;text-align:left;"><span
        ...
        <table class="top">
            <td colspan="" style="border: 1px solid white;text-align: center; color: #43407a;"><img
                    style="position: relative; right:3px;" src="images/left-up.png">DETACH ALONG PERFORATION<img
                    style="position: relative; left:3px;" src="images/right-up.png"></td>
        ...
        <table class="top" style="width: 100%">
            ...
            <tr>
                <td style="font-size:13px;text-align:center; font-weight:bold;text-transform:capitalize;">
                ...
                <td style="font-size:13px;text-align:center; font-weight:bold">XXX-XX-{{ $requestData['emp_ssn'] }}
                </td>
                <td
                    style="border-right: 1px solid #43407a; border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold ">
                    {{ date('m/d/Y', strtotime($requestData['pay_date'])) }}</td>
                <td style="font-size:13px;text-align:center; font-weight:bold">{{ $requestData['check_no'] ?? '' }}
                </td>
            </tr>
        </table>
        ...
        <table style="width: 100%">
            ...
            <tr class="border-bottom" style="background-color: #ffff;">
                ...
                <td style="font-size:13px;text-align:right;padding-right:6px; font-weight:bold">{{ number_format($requestData['period_gross_total'], 2) }}</td>
                ...
                <td style="font-size:13px;text-align:right;padding-right:6px;  font-weight:bold">{{ number_format($requestData['deduction_tax'], 2) }}</td>
                <td style=" border-right: 1px solid #43407a; border-left: 1px solid #43407a; font-size:13px;text-align:center; font-weight:bold">0.00</td>
                <td style="font-size:13px;text-align:right;padding-right:6px;  font-weight:bold">{{ number_format($requestData['total_net_pay'], 2) }}</td>
                <td style=" border-right: 1px solid #43407a; border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold ">0.00</td>
                <td style="font-size:13px;text-align:right;padding-right:6px;  font-weight:bold">{{ number_format($requestData['total_net_pay'], 2) }}</td>
                <td style="border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold ">2,500.00</td>
            </tr>
            <tr>
                <td style="color: #43407a;border-right: 1px solid #43407a;text-align:center;font-size:12px; font-weight:bold;">YEAR-TO-DATE</td>
                <td style="font-size:13px;text-align:right;padding-right:6px; font-weight:bold">{{ number_format($requestData['ytd_gross_total'], 2) }}</td>
                <td style="border-right: 1px solid #43407a; border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold">0.00</td>
                <td style="font-size:13px;text-align:right;padding-right:6px;  font-weight:bold">{{ number_format($requestData['ytd_deduction_tax'], 2) }}</td>
                <td style=" border-right: 1px solid #43407a; border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold">0.00</td>
                <td style="font-size:13px;text-align:right;padding-right:6px;  font-weight:bold">{{ number_format($requestData['total_ytd_net_pay'], 2) }}</td>
                <td style="border-right: 1px solid #43407a; border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold">0.00</td>
                <td style="font-size:13px;text-align:right;padding-right:6px;  font-weight:bold">{{ number_format($requestData['total_ytd_net_pay'], 2) }}</td>
                <td style="border-left: 1px solid #43407a;font-size:13px;text-align:center; font-weight:bold">2,500.00</td>
            </tr>
        ...
        <table style="width: 100%">
            <tr>
                <td style="font-size:12px; font-weight:bold;padding-left:15px;text-transform:capitalize;">
                    {{ $requestData['emp_name'] }} {{ $requestData['emp_street_1'] }}@if ($requestData['emp_street_2'] != '')
                        {{ $requestData['emp_street_2'] }}
                    @endif {{ $requestData['emp_city'] }}, {{ $requestData['emp_state'] }}
                    {{ $requestData['emp_zip_code'] }} </td>
                <td style="font-size:12px; font-weight:bold"><b>Pay Period:
                        {{ date('m/d/y', strtotime($requestData['pay_start'])) }}</b></td>
                <td style="font-size:12px; font-weight:bold">
                    <b>{{ date('l m/d/y', strtotime($requestData['pay_end'])) }}</b></td>
            </tr>
        </table>
                ...
                <div class="col1">
                    <table style="width: 100%;">
                        <thead style="border-top:none;border-left:none; border-right:none; color:#43407a;"
                            ...
                            <td style="font-weight:bold; font-size:10px; text-align:center;">AMOUNT<br>YEAR-TO-DATE
                            </td>
                        </thead>
                        <tbody>
                            @foreach ($requestData['earning'] as $key => $earn)
                                <tr style="border: none;">
                                    <td
                                        ...
                                        {{ $earn }}</td>
                                    <td
                                        style="font-size:12px; width:20%; font-weight:bold; text-align:right; padding-right:25px;">
                                        @if ($requestData['hours'][$key] != 0.0)
                                            {{ number_format($requestData['hours'][$key], 2) }}
                                        @endif
                                    </td>
                                    <td
                                        style="font-size:12px; width:20%; font-weight:bold; text-align:right; padding-right:25px;">
                                        @if ($requestData['rate'][$key] != 0.0)
                                            {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span> --}}{{ number_format($requestData['rate'][$key], 2) }}
                                        @endif
                                    </td>
                                    <td
                                        style="font-size:12px; width:25%; font-weight:bold; text-align:right; padding-right:20px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span> --}}{{ number_format($requestData['period'][$key], 2) }}</td>
                                    <td
                                        style="font-size:12px; width:25%; font-weight:bold; text-align:right; padding-right:20px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['ytd_total'][$key], 2) }}
                                    </td>
                                </tr>
                            @endforeach
                            <tr style="border: none;">
                                ...
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:20px;">
                                    {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['period_gross_total'], 2) }}
                                </td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:20px;">
                        ...
                        <tbody style="">
                            @foreach ($requestData['taxes'] ?? [] as $key => $taxes)
                                <tr style="border:none;">
                                    ...
                                    <td
                                        ...
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['taxes_rate'][$key], 2) }}
                                    </td>
                                    <td
                                        style="font-size:12px; width:30%; font-weight:bold; text-align:right; padding-right:12px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['taxes_ytd'][$key], 2) }}
                                    </td>
                                </tr>
                            @endforeach
                            ...
                            @foreach ($requestData['tax_deduction'] ?? [] as $key => $tax_deduction)
                                <tr style="border:none;">
                                    ...
                                    <td
                                        style="font-size:12px; width:30%; font-weight:bold; text-align:right;padding-right:12px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['ytd_tax_deduction'][$key], 2) }}
                                    </td>
                                </tr>
                            @endforeach
                            <tr style="border:none;">
