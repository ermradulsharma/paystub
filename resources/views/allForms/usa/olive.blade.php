...
<body>
    <main class="bg-img2">
        <img src="{{ public_path('images/border/olive/olive.svg') }}"
            style="position: absolute; top: 0px; right:0px;left: 0px; width:106%; height:105%;  z-index: -1;">
        <img src="{{ public_path('images/check2.svg') }}"
            style="position: absolute; top:75.6%; width:100.2%; height:25%;  z-index: -1; right:0px; left:0px;">
        @guest
                    ...
                    @if(Auth::user()->expiryDate <= $date || !isset($requestData['watermark'])) <div class="watermark">
                        ...
                        <section class="invoiceborder">
                            ...
                            <section class="tablesection">
                                ...
                                <p
                                    style="margin-top:5px; color:#000; font-size:14px; font-family: Arial, Helvetica, sans-serif; ">
                                    Your taxes and deductions for this period are <span
                                        style="font-size:14px; font-family: 'DejaVu Sans', sans-serif;">{{
                                        $requestData['currency'] }}</span>{{
                        ...
                        <section style="position: fixed; bottom:55px; width:95%; left:40px;">
                            <table>
                                <tr>
                                    <td>
                                        <table
                                            style="width:100%; @if($requestData['address_2']!='') padding-bottom:50px; @else padding-bottom:57px; @endif">
                                            <tr>
                                                <td style="">
                                                    <p
