    ...
    <main class="bg-img2">
        ...
        <section style="position: fixed; bottom:55px; width:95%; left:40px;">
            <table>
                <tr>
                    <td>
                        <table style="width:100%; @if($requestData['address_2']!='') padding-bottom:47px; @else padding-bottom:56px; @endif">
                            <tr>
                                <td style="">
                                    <p
                    ...
                    <td>
                        <table style="width:100%; position: relative;">
                            <tr class="bottom-content">
                                ...
                                <td style="text-align:right; font-size:14px;  width:22.7%; padding-right:5px;"> XXXXX{{
