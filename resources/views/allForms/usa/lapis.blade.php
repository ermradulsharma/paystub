    ...
    <main class="bg-img2">
        ...
        <section class="invoiceborder">
            ...
            <section class="section_2">
                ...
                @else
                    <table>
                        <tr>
                            <td style="width: 40%;">
                                <p style="font-size:14px;font-weight:400; font-family: 'Arial', sans-serif;">
                                    SSN: XXX-XX-{{ $requestData['emp_ssn'] }}</p>
                                <p
                ...
                <table>
                    ...
                    @foreach ($requestData['earning'] as $key => $earn)
                        <tr>
                            ...
                            <td colspan="2" style="color:#000; font-size:15px; padding-right:20px" class="alignl">
                    ...
                    <tfoot class="tfooter" style="background:#3071bd; color:white">
                        <tr>
                            ...
                            <td style="font-size:15px;padding:7px 0px;  text-align:right;font-weight:400;"
                                id=""><span
                                    style="font-family: 'DejaVu Sans', sans-serif;text-align:right;">{{ $requestData['currency'] }}</span>{{ number_format($requestData['period_gross_total'], 2) }}
                            </td>
                            <td style="" id="alignR" style="font-size:15px; font-weight:400;"><span
                                    style="font-family: 'DejaVu Sans', sans-serif;text-align:right;">{{ $requestData['currency'] }}</span>{{ number_format($requestData['ytd_gross_total'], 2) }}
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <section class="tablesection">
                ...
                <p style="margin-top:5px; color:#000; font-size:14px; font-family: Arial, Helvetica, sans-serif; ">
                    Your taxes and deductions for this period are <span
                        style="font-size:14px; font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span>{{ number_format($requestData['deduction_tax'], 2) }}
                </p>
            </section>
        </section>
