...
<body>
    <div class="container"
        ...
        <div
            ...
            <div style="padding: 0px 20px;">
                ...
                <span style="margin: 0;float:right; text-align:center; ">{{ $requestData['currency'] }}{{ number_format($requestData['total_net_pay'], 2) }}</span>
                <span style="margin: 0;float:right; margin-right: 10px;text-align:center;">XXXXXX{{ $requestData['transit_aba_number'] }}</span>
                <span style="margin: 0;float:right; margin-right: 10px;text-align:center;">XXXXXXXXXXXXXXXXX{{ $requestData['account_number_last_4'] }}</span>
            </div>
        </div>
        <div
    ...
    <table class="top">
        ...
        <tr>
            ...
            <td style="border-right: 1px solid #afaec5; border-left: 1px solid #afaec5;"> {{ $requestData['cname'] }}</td>
            <td>{{ $requestData['emp_ssn'] }} </td>
            <td style="border-right: 1px solid #afaec5; border-left: 1px solid #afaec5;"> {{ $requestData['emp_id'] }}</td>
            <td>{{ $requestData['emp_ssn'] }} </td>
    ...
    <table>
        ...
        <tr style="background-color: #f2f2f2;">
            ...
            <td style=" border-right: 1px solid #afaec5; border-left: 1px solid #afaec5; "> 0.00</td>
            <td>{{ $requestData['currency'] }}{{ number_format($requestData['total_net_pay'], 2) }}</td>
            <td style="border-left: 1px solid #afaec5; ">{{ $requestData['currency'] }}2,500.00</td>
        </tr>
