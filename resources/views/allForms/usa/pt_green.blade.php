...
<body>
    <main class="bg-img2">
        ...
        <div class="container"
                ...
                <div style="width:40%;float:right;">
                    <h6 style="font-size: 16px; margin-bottom: 0; padding-left:12%;text-transform-capitalize;">Advice
                        Number: <span style="font-size: 13px;text-transform:uppercase;">00000{{
                            $requestData['advice_number'] }}</span>
                    </h6>
                    <br>
                    <br>
            ...
            <div style="width: 100%; margin: 30px auto 0;font-size: 15px; padding: 0 0px 0px 0px;">
                <div style="padding: 0px 20px;">
                    <span>Pay To:<b
                            style="text-transform:uppercase; padding-left:10px;font-size:13px; text-align:Center;"> {{
                    ...
                    <span style="margin: 0;float:right;margin-left: 20px;font-weight:bold; font-size:16px;">{{
                        $requestData['currency'] }}{{ $requestData['total_net_pay'] }}</span>
        ...
        <table>
            ...
            <tr class="border-bottom" style="background-color: #fff;">
                <td
                    ...
                    THIS CHECK</td>
                <td style="font-size:13px; text-align:Center; font-weight:bold">{{ $requestData['currency'] }}{{
        ...
        <table>
            <tr>
                <td style="font-size:12px;padding-left:15px; font-weight:bold"> {{ $requestData['emp_street_1'] }}, {{
                    ...
                    <table style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr style="border: none;">
                                ...
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{
                                    $requestData['currency'] }}{{ number_format($requestData['rate'][$key], 2) }} </td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{
                                    $requestData['currency'] }} {{ number_format($requestData['period'][$key], 2) }}
                                </td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{
                                    $requestData['currency'] }} {{ number_format($requestData['ytd_total'][$key], 2) }}
                                </td>
                            </tr>
                            @endforeach
                            <tr style="border: none;">
                        ...
                        <tbody style=" ">
                            ...
                            <tr style="border:none;">
                                <td style="font-size:12px; font-weight:bold; text-align:left; padding-left:20px;">{{
                                    $taxes }}</td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{
                                    $requestData['currency'] }} {{ number_format($requestData['taxes_rate'][$key], 2) }}
                                </td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{
