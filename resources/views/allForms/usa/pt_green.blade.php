...
<body>
    ...
    @endauth
            <div class="container"
                ...
                <div class="row"
                    ...
                    <div style="width: 60%;float:left;">
                        ...
                        <p style="font-size: 14px; margin: 0;text-transform:uppercase;">
                            ...
                            {{ $requestData['state'] }} {{ $requestData['zip_code'] }}
                        </p>
                    </div>
                    <div style="width:40%;float:right;">
                        <h6 style="font-size: 16px; margin-bottom: 0; padding-left:12%;text-transform:capitalize;">
                            Advice
                            Number: <span
                        ...
                        <P
                            ...
                            <span style=" padding-left:10px;">Date:</span><b
                                style="padding-left:30px;">{{ date('m/d/y', strtotime($requestData['pay_date'])) }}</b>
                        </P>
                    </div>
                </div>
                <div style="padding-top:30px;">
                    <table style="">
                        <tr style="border-right:none; border-left:none; border-top:none;">
                            ...
                            <td style="text-transform:capitalize; font-size:13px; padding-left:8px;font-weight:bold;">
                                Amount</td>
                        </tr>
                ...
                <div
                    style="width: 100%;  background-color: #3e787a  ; text-align: center; color: aliceblue; font-size: 12px;">
                    <p style="margin: 0;">THE FACE OF THIS DOCUMNET HAS A COLOURED BACKGROUND-NOT A WHITE BACKGROUND</p>
                </div>
            </div>

            <table class="top">
                <td colspan="" style="border: 1px solid white;text-align: center; color: #3e787a;"><img
                        style="position: relative; right:3px;" src="images/green-left.png">DETACH ALONG
                    PERFORATION<img style="position: relative; left:3px;" src="images/green-right.png"></td>
            ...
            <table class="top">
                ...
                <tr>
                    ...
                    <td style="font-size:13px;text-align:center; font-weight:bold"> {{ $requestData['client_no'] }}
                    </td>
                    <td
            ...
            <table>
                ...
                <tr class="border-bottom" style="background-color: #ffff;">
                    <td
                        style="color: #3e787a;border-right: 1px solid #3e787a; text-align:center;font-size:12px; font-weight:bold;">
                        THIS CHECK</td>
                    ...
                    <td style="font-size:13px;text-align:right;padding-right:6px; font-weight:bold">
                        {{-- <span
                        style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span> --}}{{ number_format($requestData['total_net_pay'], 2) }}</td>
                    <td style="border-left: 1px solid #3e787a;font-size:13px; text-align:Center; font-weight:bold ">
                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span> --}}2,500.00</td>
                </tr>
                <tr>
                    <td
                        style="color: #3e787a;border-right: 1px solid #3e787a;font-size:12px; text-align:Center; font-weight:bold">
                        YEAR-TO-DATE</td>
                    <td style="font-size:13px;text-align:right;padding-right:6px; font-weight:bold">
                        {{-- <span
            ...
            <table>
                <tr>
                    <td style="font-size:12px; font-weight:bold;padding-left:15px;text-transform:capitalize;">
                        {{ $requestData['emp_name'] }} {{ $requestData['emp_street_1'] }}@if ($requestData['emp_street_2'] != '') {{ $requestData['emp_street_2'] }}@endif {{ $requestData['emp_city'] }}, {{ $requestData['emp_state'] }}
                        ...
                        <table style="width: 100%;">
                            <thead style="border-top:none;border-left:none; border-right:none; color:#3e787a;"
                                ...
                                <td
                                    ...
                                    HOURS</td>
                                <td
                                    style="font-size:10px; font-weight:bold;text-align:center; border-right:1px solid  #3e787a; text-transform:uppercase;">
                                    Rate</td>
                                <td
                                    style="font-size:10px; font-weight:bold;text-align:center; border-right:1px solid  #3e787a;">
                            ...
                            <tbody>
                                @foreach ($requestData['earning'] as $key => $earn)
                                    <tr style="border: none;">
                                        ...
                                        <td
                                            ...
                                            {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span> --}}{{ number_format($requestData['period'][$key], 2) }}
                                        </td>
                                        <td
                                            style="font-size:12px; width:20%; font-weight:bold; text-align:right; padding-right:20px;">
                                ...
                                <tr style="border: none;">
                                    <td colspan="3"
                                        ...
                                        Total Wages:</td>
                                    <td
                                        style="font-size:12px; font-weight:bold; text-align:right; padding-right:20px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['period_gross_total'], 2) }}
                                    </td>
                                    <td
                                        style="font-size:12px; font-weight:bold; text-align:right; padding-right:20px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['ytd_gross_total'], 2) }}
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="col2">
                        <table style="width: 100%; padding-bottom:70px;">
                            ...
                            <tbody style="">
                                ...
                                @endforeach
                                <tr style="border:none;">
                                    <td style="font-size:12px; font-weight:bold; text-align:left; padding-left:20px;">
                                        Total
                                        Taxes:</td>
                                    <td
                                        style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">
                                        {{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency']}}</span> --}}{{ number_format($requestData['deduction_tax'], 2) }}
                                    </td>
                                    <td
                                        style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">
