...
<body>
    <main class="bg-img2">
        ...
        <table class="top">
            <td colspan="" style="border: 1px solid white;text-align: center; color: #3e787a;"><img style="position: relative; right:3px;" src="images/green-left.png">DETACH ALONG
        ...
        <table>
            ...
            <tr class="border-bottom" style="background-color: #ffff;">
                ...
                <td style="font-size:13px;text-align:center; font-weight:bold"><span
                        style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span>{{
                    number_format($requestData['total_net_pay'], 2) }}</td>
                <td style="border-left: 1px solid #3e787a;font-size:13px; text-align:Center; font-weight:bold "><span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span>2,500.00</td>
            </tr>
            <tr>
                <td
        ...
        <table>
            <tr>
                <td style="font-size:12px; font-weight:bold;padding-left:15px;">{{ $requestData['emp_name'] }} {{ $requestData['emp_street_1'] }} {!! empAddressTwo($requestData,false,true) !!} {{ $requestData['emp_city'] }}, {{ $requestData['emp_state'] }} {{ $requestData['emp_zip_code'] }} </td>
