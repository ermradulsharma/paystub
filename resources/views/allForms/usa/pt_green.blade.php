...
<body>
    <main class="bg-img2">
        ...
        <div class="container"
            ...
            <div class="row" style="display: flex; display: flex;justify-content: space-between;padding: 0px 14px;">
                <div style="width: 60%;float:left;">
                    ...
                    <p style="font-size: 14px; margin: 0;text-transform:uppercase;"> {{ $requestData['address_1'] }} {{ $requestData['address_2'] }}<br>{{ $requestData['city'] }}<br> {{ $requestData['state'] }}, {{ $requestData['zip_code'] }}</p>
                </div>
            ...
            <div style="width: 100%; margin: 30px auto 0;font-size: 15px; padding: 0 0px 0px 0px;">
                <div style="padding: 0px 20px;">
                    <span>Pay To:<b style="text-transform:uppercase; padding-left:10px;font-size:13px; text-align:Center;"> {{ $requestData['emp_name'] }} </b></span>
            ...
            <div style="width: 50%; display: flex; justify-content: flex-end;justify-content: start; font-size: 17px; margin: 0px 0 0 100px; padding:0px 30px;">
        ...
        <table class="top">
            <td colspan="" style="border: 1px solid white;text-align: center; color: #3e787a;">----DETATCH ALONG PERFORMATION----</td>
            <td style="border: 1px solid white; text-align: center; color: #3e787a;">KEEP LOWER PART FOR YOUR RECODE</td>
        </table>
        ...
        <table class="top">
            ...
            <tr>
                ...
                <td style="border-right: 1px solid #3e787a; border-left: 1px solid #3e787a;font-size:13px; text-align:Center; font-weight:bold"> {{ $requestData['cname'] }} </td>
                <td style="font-size:13px; text-align:Center; font-weight:bold">{{ $requestData['emp_ssn'] }} </td>
                <td style="border-right: 1px solid #3e787a; border-left: 1px solid #3e787a;font-size:13px; text-align:Center; font-weight:bold"> {{ $requestData['emp_id'] }} </td>
                <td style="font-size:13px; text-align:Center; font-weight:bold">{{ $requestData['emp_ssn'] }} </td>
                <td style="border-right: 1px solid #3e787a; border-left: 1px solid #3e787a;font-size:13px; text-align:Center; font-weight:bold "> {{ date('m/d/Y', strtotime($requestData['pay_date'])) }}</td>
        ...
        <table>
            ...
            <tr class="border-bottom" style="background-color: #fff;">
                ...
                <td style=" border-right: 1px solid #3e787a; border-left: 1px solid #3e787a; font-size:13px; text-align:Center; font-weight:bold"> 0.00</td>
                <td style="font-size:13px; text-align:Center; font-weight:bold">{{ $requestData['currency'] }}{{ number_format($requestData['total_net_pay'], 2) }}</td>
                <td style="border-left: 1px solid #3e787a;font-size:13px; text-align:Center; font-weight:bold ">{{ $requestData['currency'] }}2,500.00</td>
            </tr>

            <tr>
                <td style="color: #3e787a;border-right: 1px solid #3e787a;font-size:12px; text-align:Center; font-weight:bold">YEAR-TO-DATE</td>
                        ...
                        <tbody>
                            @foreach ($requestData['earning'] as $key => $earn)
                                <tr style="border: none;">
                                    ...
                                    <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{ number_format($requestData['hours'][$key], 2) }}</td>
                                    <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{ $requestData['currency'] }}{{ number_format($requestData['rate'][$key], 2) }}  </td>
                                    <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{ $requestData['currency'] }} {{ number_format($requestData['period'][$key], 2) }}</td>
                                    <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{ $requestData['currency'] }} {{ number_format($requestData['ytd_total'][$key], 2) }}</td>
                                </tr>
                            @endforeach
                            <tr style="border: none;">
                                <td colspan="3" style="text-align:left;font-size:12px; font-weight:bold;text-align:left; padding-left:20px;">Total Wages</td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{ $requestData['currency'] }}{{ number_format($requestData['period_gross_total'], 2) }} </td>
                                <td style="font-size:12px; font-weight:bold; text-align:right; padding-right:12px;">{{ $requestData['currency'] }}{{ number_format($requestData['ytd_gross_total'], 2) }} </td>
                            </tr>
                        </tbody>
                ...
                <div class="col2">
                    <table style="width: 100%;">
                        <thead style="border-top:none;color:#3e787a;border-left:none;" id="backcolor">
                            <td style="font-size:10px; font-weight:bold;text-align:center; border-right:1px solid  #3e787a;">DEDUCTIONS & TAXES</td>
                            <td style="font-size:10px; font-weight:bold;text-align:center; border-right:1px solid  #3e787a;  ">AMOUNT<br>THIS CHECK</td>
