            ...
            <section>
                <table class="table-data">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; padding-right:19px;"> {{ $requestData['deduction_tax']}}</td>
                        <td style="text-align: right;padding-right:18px;">{{ $requestData['ytd_deduction_tax']}}</td>
                    </tr>
                    <tr>
                        <td></td>
