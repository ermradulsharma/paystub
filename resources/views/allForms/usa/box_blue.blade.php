...
<body>
    ...
    <main class="bg-img2">
        ...
        <section style="position: fixed; bottom:15px; width:95%; left:60px;padding-top:30px;">
            <table>
                <tr style="">
                    <td>
                        <table style="width:95%; padding-bottom:50px;">
                            <tr>
                ...
                <tr style="">
                    <td>
                        <table style="width:95%;background-color:Red; position: relative; top:10px;">
