                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td style="border-bottom: 2px solid #000;">
                            </b>{{ date('m/d/y', strtotime($requestData['pay_start'])) }} -  {{ date('m/d/y', strtotime($requestData['pay_end'])) }}</b></td>
                    </tr>
                    <tr>
                        <td colspan="7"></td>
                    </tr>
            ...
            <div class="container" style=" margin-top:40px; width:100%;">
                <div class="row" style="display: flex;justify-content: space-between;padding: 0px 14px;">
                    <div style="width: 50%;float:left; position: relative; top:35px;">
                        <p style="font-size:14px;text-align:left;  width:55%;">{{ $requestData['emp_name'] }}</p>
                    ...
                    <div style="width: 50%;float:right;text-align:right;position: relative; right:20px;">
                        <h6 style="font-size: 14px; margin-bottom: 0; position: relative; top:-8px;"> <span style="">00000{{ $requestData['advice_number'] }}</span> </h6>
                        <p style=" position: relative; top:-18px; font-size:13px;"><span style="font-weight:800;"></span>{{ date('m/d/y', strtotime($requestData['pay_date'])) }}</p>
                    </div>
                </div>
                <table style="width: 95%; margin: 140px  auto 0px; padding:0px 20px;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-size:12px; width:20%;"> XXXXX{{ $requestData['account_number_last_4'] }}</td>
                        <td></td>
                        <td style="text-align:right;font-size:12px; width:15%;"> XXXXX{{ $requestData['transit_aba_number'] }}</td>
                        <td style="text-align:right;font-size:12px; width:15%;"> {{ number_format($requestData['total_net_pay'], 2) }} </td>
                    </tr>
                </table>
            </div>
        </section>
