...
<body>
    <main class="bg-img2">
        <img src="{{ public_path('images/border/tawny/tawny.svg') }}"
                        ...
                        <section class="invoiceborder">
                            <table>
                                ...
                                <tr>
                                    <td class="address"
                                        ...
                                        $requestData['address_2'] }}<br>@endif{{ $requestData['city'] }} {{
                                        $requestData['state'] }}. {{$requestData['zip_code'] }}<br>USA</td>
                                    <td style=" font-size:20px;font-family: Arial, Helvetica, sans-serif; font-weight:bold; color:#04070a;"
                            ...
                            <section class="section_2">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td class="earning"
                                            ...
                                            {{ $requestData['emp_street_1'] }}<br>{{$requestData['emp_street_2']
                                            }}<br>{{ $requestData['emp_city'] }}, {{ $requestData['emp_state'] }} {{
                                ...
                                <table>
                                    <tr>
                                        <td style="width: 40%;">
                                            <p
                                                style="font-size:14px;font-weight:400; font-family: 'Arial', sans-serif;">
                                                SSN: XXX-XX-{{
                            ...
                            <section class="tablesection">
                                <table style="width: 100%;">
                                    ...
                                    <tr>
                                        <td style="font-size:15px; color:#000; text-transform:capitalize;">{{ $earn }}
                                        </td>
                                        <td style="font-size:15px; color:#000 !important;">
                                            @if($requestData['rate'][$key] != 0.00)<span
                                                style="font-family: 'DejaVu Sans', sans-serif;">{{
                                                $requestData['currency'] }}</span>{{
                                            number_format($requestData['rate'][$key], 2) }}@endif</td>
                                        <td colspan="2" style="color:#000; font-size:15px; padding-right:20px"
                                            class="alignl">@if($requestData['hours'][$key] != 0.00){{
                                            number_format($requestData['hours'][$key],2) }}@endif</td>
                                        <td style="font-size:15px; color:#000;" class="alignR"><span
                                                style="font-family: 'DejaVu Sans', sans-serif;">{{
                                                $requestData['currency'] }}</span>{{
                                            number_format($requestData['period'][$key], 2) }}</td>
                                        <td class="alignR" style="font-size:15px; color:#000;"><span
                                                style="font-family: 'DejaVu Sans', sans-serif;">{{
                                    ...
                                    <tfoot class="tfooter" style="background:#bd812e; color:white">
                                        <tr>
                                            <td colspan="4"></td>
                                            <td style="font-size:15px;padding:7px 0px;  text-align:right;font-weight:400;"
                                                id=""><span
                            ...
                            <section class="tablesection">
                                <table class="heading">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td class="data" id="color" style="font-size:15px;  color:#000;">{{ $taxes }}
                                        </td>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="text-transform: capitalize;font-size:16px; color:#000;" class="data"
                                            id="color">{{ $tax_deduction }}</td>
                                        <td id="color" class="alignR"
                                            style="font-size:16px; color:#000; font-family: Arial, Helvetica, sans-serif;">
                                        ...
                                        <td id="color" class="alignR"
                                            ...
                                            <span style="font-family: 'DejaVu Sans', sans-serif;">{{
                                                $requestData['currency']
                                                }}</span>{{number_format($requestData['ytd_tax_deduction'][$key], 2) }}
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
                                    <tfoot class="tfooter " style="background:#bd812e; color:white">
                                        <tr>
                                            <td colspan="2" style="font-weight:bold;font-size:15px; padding:10px;">Net
                                                Pay</td>
                                ...
                                <p
                                    style="margin-top:5px; color:#587193; font-size:14px; font-family: Arial, Helvetica, sans-serif; ">
                                    Your taxes and deductions for this period are <span style="color: #555555"> <span
                                            ...
                                            }}</span>{{ number_format($requestData['deduction_tax'], 2) }}</span></p>
                            </section>
                        </section>
                        <section style="position: fixed; bottom:55px; width:95%; left:40px;">
                            <table>
                                <tr>
                                    <td>
                                        <table
                                            style="width:100%; @if($requestData['address_2']!='') padding-bottom:51px; @else padding-bottom:58px; @endif">
                                            <tr>
                                                <td style="">
                                                    <p
                                                ...
                                                <td style="text-align:right;padding-right:20px;">
                                                    ...
                                                    <p
                                                        style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; font-weight: 400; position: relative;   @if($requestData['address_2'] !='' ) bottom:2px; @else bottom:1px;  @endif">
                                                        {{ date('m/d/Y', strtotime($requestData['pay_date'])) }} </p>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <td>
                                        <table style="width:100%; position: relative; ">
                                            <tr class="bottom-content">
                                                ...
                                                <td
                                                    style="text-align:right; font-size:14px;  width:22.7%;padding-right:6px; ">
                                                    XXXXX{{
                                                    $requestData['account_number_last_4'] }}</td>
                                                <td
                                                    style="text-align:center; font-size:14px;  width:20%; padding-right:7px; ">
                                                    XXXXX{{
                                                ...
                                                <td
                                                    ...
                                                    <span style="font-family: 'DejaVu Sans', sans-serif;">{{
                                                        $requestData['currency']
                                                        }}</span>{{ number_format($requestData['total_net_pay'], 2) }}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
