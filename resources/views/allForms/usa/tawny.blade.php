    ...
    <main class="bg-img2">
            ...
            <section class="tablesection">
                <table>
                    <tr>
                        ...
                        <td id="color" style="font-size:13px color:#000;">@if($requestData['rate'][$key] != 0.00)<span style="font-family: 'DejaVu Sans', sans-serif; padding-right:1px;">{{ $requestData['currency'] }}</span>{{ number_format($requestData['rate'][$key], 2) ?? '' }}@endif
                        </td>
        ...
        <section style="position: fixed; bottom:55px; width:95%; left:40px;">
            <table>
                <tr>
                    <td>
                        <table style="width:100%; @if($requestData['address_2']!='') padding-bottom:51px; @else padding-bottom:57px; @endif">
                            <tr>
                                <td style="">
                                    <p
