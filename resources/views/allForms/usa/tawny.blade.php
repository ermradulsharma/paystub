    ...
    <main class="bg-img2">
        ...
        <section class="invoiceborder">
            <table>
                ...
                <tr>
                    <td class="address"
                        style="padding-left: 31px;font-size:12px;line-height:1.7;text-transform:uppercase;">
                ...
                <tr>
                    <td></td>
                    <td>
                        <p class="earning" style="font-size:12px;"> Pay Period:
            ...
            <section class="section_2">
                <table>
                    <tr>
                        <th
                            style="width: 40%;font-size:14px;font-weight:400; padding-bottom:0px !important;padding-top:0px !important;">
                            SSN: XXX-XX-{{ $requestData['emp_ssn'] }}</th>
                        <th class="earning"
                            style="width: 60%;font-weight:400 !important;padding-bottom:0px !important;padding-top:0px !important;margin:0px;font-size:14px;">
                            {{ $requestData['emp_name'] }}</th>
                    </tr>
                    <tr>
                        <td
                            style=" padding: 0px 0px 0px 9px; font-size:14px;font-weight:400;padding-bottom:0px !important;padding-top:0px !important;">
                            Stub No: {{ $requestData['stub_no'] }} </td>
                        <td
                            class="earning"style="font-size:14px;padding-bottom:0px !important;padding-top:0px !important;">
                ...
                <div class="container" style=" margin-top:60px; width:95%; padding:0px 20px;">
                    <div class="row" style="display: flex;justify-content: space-between;padding: 0px 14px;">
                        ...
                        <div style="width: 50%;float:right;text-align:right; margin-top:6px;">
                            <h6 style="font-size: 14px; margin-bottom: 7px;">
