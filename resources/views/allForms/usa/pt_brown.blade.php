...
<body>
    <main class="bg-img2">
        ...
        <table class="top">
            <td colspan="" style="border: 1px solid white;text-align: center; color: #793b5b  ;"><img src="images/brown-left.png">DETATCH ALONG
                PERFORMATION<img src="images/brown-right.png"></td>
