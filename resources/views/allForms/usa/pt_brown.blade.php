...
<body>
    <main class="bg-img2">
        ...
        <table class="top">
            <td colspan="" style="border: 1px solid white;text-align: center; color: #793b5b  ;"><img style="position: relative; right:3px;" src="images/brown-left.png">DETACH ALONG
                PERFORATION<img style="position: relative; left:3px;" src="images/brown-right.png"></td>
            <td style="border: 1px solid white; text-align: center; color: #793b5b  ;">KEEP LOWER PART FOR YOUR RECORDS
            </td>
        </table>
        <table class="top">
            <tr>
            ...
            <div class="row roww">
                <div class="col1">
                    <table style="width: 100%;">
                        <thead style="border-top:none; border-left:none; border-right:none; color:#793b5b ;width:20%;"
                            id="backcolor">
                            <td
                                style="font-size:10px; font-weight:bold; text-align:center; border-right:1px solid #793b5b; width:20%;">
                                WAGES</td>
                            <td
                                style="font-size:10px; font-weight:bold; text-align:center; border-right:1px solid #793b5b ;width:20%;">
                                HOURS</td>
                            <td
                                style="border-right:1px solid  #793b5b; width:20%;font-size:10px; font-weight:bold; text-align:center;">
                                RATE</td>
                            <td
                                style="font-size:10px; font-weight:bold; text-align:center; border-right:1px solid  #793b5b ;width:20%;">
                                AMOUNT <br>THIS CHECK</td>
                            <td style="font-size:10px; font-weight:bold; text-align:center;width:20%;">AMOUNT<br> YEAR-TO-DATE
                            </td>
                        </thead>
                        <tbody>
                            ...
                            <tr style="border: none;">
                                ...
                                <td style="font-size:12px; width:20%; font-weight:bold; text-align:right; padding-right:30px;">@if($requestData['rate'][$key] != 0.00){{-- <span style="font-family: 'DejaVu Sans', sans-serif;">{{ $requestData['currency'] }}</span> --}}{{ number_format($requestData['rate'][$key], 2) }}@endif</td>
                ...
                <div class="col2">
                    <table style="width: 100%;">
                        <thead style="border-top:none;color:#793b5b  ;" id="backcolor">
                            <td
                                style="font-size:10px; font-weight:bold;text-align:center; border-right:1px solid  #793b5b; width:40%;">
                                DEDUCTIONS & TAXES</td>
                            <td
                                style="font-size:10px; font-weight:bold;text-align:center; border-right:1px solid  #793b5b ;width:30%;  ">
                                AMOUNT<br>THIS CHECK</td>
                            <td
