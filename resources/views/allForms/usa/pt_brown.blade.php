    ...
    <main class="bg-img2">
        ...
        <div class="container" style="border-right: 1px solid   #793b5b; margin: auto;border-top: 1px solid   #793b5b; border-left: 1px solid   #793b5b; border-bottom:none;padding: 0 0px 0px 0px;">
            <div class="row" style="display: flex; display: flex;justify-content: space-between;padding: 0px 14px;">
                <div style="width: 60%;float:left;">
                    ...
                    <p style="font-size: 14px; margin: 0;"> {{ $requestData['address_1'] }} { $requestData['address_2'] }}</br>{{ $requestData['city'] }} {{ $requestData['state'] }}, {{ $requestData['zip_code'] }}</p>
                </div>
                <div style="width: 40%;float:right">
                    <h6 style="font-size: 15px; margin-bottom: 0;">Advice Number: <span>XXXXX{{ $requestData['advice_number'] }}</span> </h6>
                    <br>
                    <br>
                    <P style="font-size: 14px;margin: 0;">
                        <span style="font-weight:800;">Check Nuumber:</span> 1775</P>
            ...
            <div style="width: 100%; margin: 30px auto 0;font-size: 15px; font-weight: 900;padding: 0 0px 0px 0px;">
                <div style="padding: 0px 20px;">
                    ...
                    <span style="margin: 0;float:right;margin-left: 20px; ">{{ $requestData['currency'] }} {{ number_format($requestData['total_net_pay'],2) }}</span>
                    <span style="margin: 0;float:right; margin-left: 30px;">XXXXX{{ $requestData['transit_aba_number'] }}</span>
                    <span style="margin: 0;float:right; margin-right: 30px;">XXXXX{{ $requestData['account_number_last_4'] }}</span>
                </div>
            </div>
            <div
        ...
        <table class="top">
            ...
            <tr>
                ...
                <td style="border-right: 1px solid #91848a; border-left: 1px solid #91848a;"> {{ $requestData['cname'] }} </td>
                <td>{{ $requestData['emp_ssn'] }} </td>
                <td style="border-right: 1px solid #91848a; border-left: 1px solid #91848a;"> {{ $requestData['emp_id'] }} </td>
                <td>{{ $requestData['emp_ssn'] }} </td>
                <td style="border-right: 1px solid #91848a; border-left: 1px solid #91848a; "> {{ date('m/d/Y', strtotime($requestData['pay_date'])) }}</td>
                <td>1877</td>
            </tr>
        </table>
        ...
        <table>
            ...
            <tr style="background-color: #f2f2f2;">
                <td style="color: #545464;border-right: 1px solid #91848a;">THIS CHECK</td>
                <td>{{ $requestData['currency'] }}{{ number_format($requestData['period_gross_total'], 2) }}</td>
                <td style=" border-right: 1px solid #91848a; border-left: 1px solid #91848a; "> 0.00</td>
                ...
                <td style=" border-right: 1px solid #91848a; border-left: 1px solid #91848a; "> 0.00</td>
                <td>{{ $requestData['currency'] }}{{ number_format($requestData['total_net_pay'], 2) }}</td>
                <td style="border-left: 1px solid #91848a; ">{{ $requestData['currency'] }}2,500.00</td>
            </tr>

            <tr>
                <td style="color: #545464;border-right: 1px solid #91848a;">YEAR-TO-DATE</td>
        ...
        <section>
            ...
            <div class="row roww">
                <div class="col1">
                    <table style="width: 100%;border-right: 1px solid #91848a;">
                        <thead style=" border-top:none;" id="backcolor">
                            <td style="font-size:9px; border-right:1px solid  #91848a;">WAGES</td>
                            <td style="border-right:1px solid  #91848a;">RATE</td>
                ...
                <div class="col2">
                    <table style="width: 100%;">
                        <thead style="border-top:none;" id="backcolor">
                            ...
                            <td style="font-size:9px;">AMOUNT<br>THIS CHECK</td>
                            <td style="border-right: none !important;   border-collapse: collapse;font-size:9px;">AMOUNT <br>YEAR-TO-DATE </td>
                        </thead>
