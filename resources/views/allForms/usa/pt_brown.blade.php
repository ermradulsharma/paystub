    ...
    <main class="bg-img2">
        ...
        <table class="top">
            ...
            <tr>
                ...
                <td style="border-right: 1px solid #91848a; border-left: 1px solid #91848a;"> {{ $requestData['cname'] }}
                </td>
                <td>{{ $requestData['emp_ssn'] }} </td>
                <td style="border-right: 1px solid #91848a; border-left: 1px solid #91848a;"> {{ $requestData['emp_id'] }}
                </td>
                <td>{{ $requestData['emp_ssn'] }} </td>
                <td style="border-right: 1px solid #91848a; border-left: 1px solid #91848a; ">
