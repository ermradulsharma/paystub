    ...
    <main class="bg-img2">
        ...
        <table class="top">
            ...
            <tr>
                ...
                <td style="border-right: 1px solid #793b5b  ; border-left: 1px solid #793b5b  ;">
                    {{ $requestData['cname'] }}
                </td>
        ...
        <table>
            ...
            <tr style="background-color: #f2f2f2;">
                <td style="color: #793b5b  ;border-right: 1px solid #793b5b  ; text-align:center;">THIS CHECK</td>
                <td>{{ $requestData['currency'] }}{{ number_format($requestData['period_gross_total'], 2) }}</td>
                <td style=" border-right: 1px solid #793b5b  ; border-left: 1px solid #793b5b  ; "> 0.00</td>
                ...
                <td style=" border-right: 1px solid #793b5b  ; border-left: 1px solid #793b5b  ; "> 0.00</td>
                <td>{{ $requestData['currency'] }}{{ number_format($requestData['total_net_pay'], 2) }}</td>
                <td style="border-left: 1px solid #793b5b  ; ">{{ $requestData['currency'] }}2,500.00</td>
            </tr>

            <tr>
                <td style="color: #793b5b  ;border-right: 1px solid #793b5b  ;text-align:center;">YEAR-TO-DATE</td>
                ...
                <div class="col1">
                    <table style="width: 100%;">
                        <thead style="border-top:none;border-left:none; border-right:none; color:#793b5b  ;"
                            id="backcolor">
                            <td style="font-size:9px; border-right:1px solid  #793b5b  ; ">WAGES</td>
                            <td style="font-size:9px; border-right:1px solid  #793b5b  ;">HOURS</td>
                            <td style="border-right:1px solid  #793b5b  ;">RATE</td>
