...
<body>
    <main class="bg-img2">
            ...
            <div class="row" style="display: flex; display: flex;justify-content: space-between;padding: 0px 14px;">
                <div style="width: 60%;float:left;">
                    ...
                    <p style="font-size: 14px; margin: 0;text-transform:uppercase;"> {{ $requestData['address_1']
                        }} {!! addressTwo($requestData,true) !!}<br>{{ $requestData['city'] }}, {{ $requestData['state'] }} {{ $requestData['zip_code'] }}
                    </p>
                </div>
            ...
            <div style="width: 50%;margin: 0px 0 0 100px; padding:0px 30px;">
                <div style="padding:50px 0px 19px;">
                    ...
                    <P
                        ...
                        {{ $requestData['emp_street_1'] }} {!! empAddressTwo($requestData,false,true) !!}</P>
                    <p
                        style="margin: 0px 0 0 0;font-size: 14px;text-transform:uppercase;font-family: Arial, Helvetica, sans-serif;">
        ...
        <table>
            <tr>
                <td style="font-size:12px; font-weight:bold;padding-left:15px;text-transform:capitalize;">{{ $requestData['emp_name'] }} {{ $requestData['emp_street_1'] }} {!! empAddressTwo($requestData,false,true) !!} {{ $requestData['emp_city'] }}, {{ $requestData['emp_state'] }}
