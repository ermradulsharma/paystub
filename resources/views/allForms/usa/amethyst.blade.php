    ...
    <main class="bg-img2">
        ...
        <section class="invoiceborder">
                ...
                <table>
                    ...
                    @foreach ($requestData['earning'] as $key => $earn)
                        <tr>
                            ...
                            <td colspan="2" id="color"style="font-size:13px;">{{ number_format($requestData['hours'][$key]) }}</td>
            ...
            <section class="tablesection">
                <table class="heading">
                    ...
                    <tfoot class="tfooter " style="background:#8a2ebd; color:white">
                        <tr>
                            ...
                            <th style="font-weight: 400 !important;font-size:13px" id="alignR">{{ $requestData['currency'] }}
                ...
                <p style="margin-top:25px; color:#555555;font-size:14px;font-family: 'Arial', sans-serif;">Your taxes and deductions for this period are
