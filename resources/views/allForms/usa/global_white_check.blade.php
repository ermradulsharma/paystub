                ...
                <div class="column1">
                    <table class="tablealign">
                        <thead style="font-size:15px; ">
                            <th style="text-align: left;width:21%;font-size:18px; ">Earnings</th>
            ...
            <div class="container" style=" margin-top:10px; width:100%; padding:0px  20px;">
                ...
                <table>
                    <tr>
                        ...
                        <td style="font-size:15px; width:23%;padding-top:30px; text-align:left;"> XXXXX<b>{{ $requestData['account_number_last_4'] }}</b></td>
