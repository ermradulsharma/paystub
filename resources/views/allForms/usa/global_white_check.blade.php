...
<body>
    <main class="bg-img2">
        ...
        @if(Auth::user()->usa_expiry_date <= $date || !isset($requestData['watermark']) || Auth::user()->usa_expiry_date
            ...
            @if(Auth::user()->usa_expiry_date <= $date || !isset($requestData['watermark'])) <div class="watermark">
                </div>
                <div class="watermark2"></div>
                @endif
                @endif
                @if (Auth::user()->device_type == 'iOS')
                @if(Auth::user()->expiryDate <= $date || !isset($requestData['watermark'])) <div class="watermark">
                    </div>
                    <div class="watermark2"></div>
                    @endif
                    @endif
                            ...
                            <div class="row2" style="width:100%">
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                {{ $requestData['address_1'] }} {!! addressTwo($requestData,true)
                                                !!}<br>{{ $requestData['city'] }}, {{ $requestData['state'] }} {{
                                ...
                                <div class="col2">
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td
                                                style="font-size:18px; font-family: 'Arial, Helvetica', sans-serif; font-weight:400; ">
                                                Period Ending:</td>
                                            <td
                                        ...
                                        <tbody style="font-size:13px;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    {{ $earn }}</td>
                                                <td
                                                    style="text-align: right;padding-right:25px; font-size:15px;font-family: Arial, Helvetica, sans-serif;">
                                                    @if($requestData['rate'][$key] != 0.00){{
                                                    number_format($requestData['rate'][$key], 2)}}@endif</td>
                                                <td
                                                    style="text-align: center; font-size:15px;font-family: Arial, Helvetica, sans-serif;">
                                                    @if($requestData['hours'][$key] != 0.00){{
                                                    number_format($requestData['hours'][$key], 2) }}@endif</td>
                                                <td
                                                    style="text-align: center; font-size:15px;font-family: Arial, Helvetica, sans-serif;padding-left:3px;">
                                                    {{ number_format($requestData['total'][$key], 2) }} </td>
                                                <td></td>
                                                <td
                                                    style="font-size:15px; font-family: Arial, Helvetica, sans-serif; text-align:right;">
                                    ...
                                    <table class="tablealign">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="4"
                                                ...
                                                Company Telephone Number:&nbsp;@if($requestData['tel'] != ''){{
                                                $requestData['tel'] ?? '' }}@endif </td>
                        ...
                        <section style="margin-top:30px;">
                            <table class="table-data" style="width: 48%;">
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="text-align: right; font-size:15px; border-bottom:3px solid black; border-top:3px solid black;font-family: Arial, Helvetica, sans-serif;">
                            ...
                            <div class="container"
                                ...
                                <div class="row"
                                    ...
                                    <div class="global-address"
                                        style="width: 50%; float:left; position: relative; @if($requestData['address_2'] != '') bottom:40px; @else bottom:30px; @endif right:0px; left:60px;">
                                        <p
                                    ...
                                    <div style="width: 50%;float:right;">
                                        <h6
                                            style="text-align:left; left:80px; position: relative; @if($requestData['address_2'] != '') bottom:47px; @else bottom:40px; @endif font-weight:400;font-size: 14px;">
                                            {{ $requestData['check_no'] }} </h6>
                                        <h6
                                            style="font-size: 14px; text-align:left; position: relative; @if($requestData['address_2'] != '') bottom:80px; @else bottom:75px; @endif left:80px; font-weight:400;">
                                            {{ date('m/d/Y', strtotime($requestData['pay_date'])) }}</h6>
                                    </div>
                                </div>
                                <table
                                    style="position:relative; @if($requestData['address_2'] != '') bottom:95px; @else bottom:90px; @endif">
                                    <tr>
                                        ...
                                        <td
                                            style="font-size:15px; width:20%;padding-top:40px; text-align:right; padding-right:38%;font-family: Arial, Helvetica, sans-serif;">
                                            <b><span style="font-family: 'DejaVu Sans', sans-serif;">{{
                                                    $requestData['currency'] }}</span>{{
                                                number_format($requestData['total_net_pay'], 2) }}</b></td>
                                    </tr>
                                </table>
