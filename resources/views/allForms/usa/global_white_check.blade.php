...
@endif --}}
            ...
            <div class="container" style=" margin-top:100px; width:100%; padding:0px 20px; @if($earn != 1) position: fixed;  top:74.6%; @elseif($tax != 0)position: fixed;  top:74.7%; @else position: relative; @if($requestData['address_2'] != '') top:64px; @else top:57px; @endif @endif">
