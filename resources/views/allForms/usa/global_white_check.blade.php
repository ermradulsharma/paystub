...
<br>
        ...
        <section class="bg-img">
            ...
            <div class="container" style=" margin-top:100px; width:100%; padding:0px 20px; @if($earn != 1) position: fixed;  top:75%; @elseif($tax != 0)position: fixed;  top:75%; @else position: relative;  top:64px; @endif">
