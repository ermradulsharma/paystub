                        ...
                        <table style="width:100%; @if($requestData['address_2']!='') padding-bottom:48px; @else padding-bottom:55px; @endif">
                            <tr>
                                ...
                                <td style="text-align:right;padding-right:20px;">
                                    <p
                                        style="font-size: 14px; margin-bottom: 5px;position:relative; bottom:3px; font-family: Arial, Helvetica, sans-serif; font-weight: 400">
                                        <span>00000{{ $requestData['advice_number'] }}</span></p>
                                    <p style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; font-weight: 400; position: relative; @if($requestData['address_2'] !='' ) bottom:5px; @else bottom:5px;  @endif">
                    ...
                    <td>
                        <table style="width:100%; position: relative; ">
                            <tr class="bottom-content">
                                ...
                                <td style="text-align:center; font-size:14px;  width:20%; padding-right:7px; "> XXXXX{{
