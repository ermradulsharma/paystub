    ...
    <main class="bg-img2">
        ...
        <section class="invoiceborder">
            <table>
                ...
                <tr>
                    <td class="address" style="padding-left: 31px;font-size:16px;text-transform:uppercase; font-weight:400;line-height:1.5; color:#000;letter-spacing:-0.5px;padding-top:0; padding-bottom:0;"> {{ $requestData['address_1'] }} <br>{{ $requestData['address_2'] }} <br> {{ $requestData['city'] }}, {{ $requestData['state'] }} {{ $requestData['zip_code'] }}<br> USA </td>
                    <td style="font-weight:600; font-size:18px;line-height:1.9;vertical-align: center;" class="earning"> Earnings Statement</td>
                </tr>
                <tr>
                    <td></td>
                    <td style="">
                        <p class="earning" style="font-size:13px; margin-top:-40px;"> Pay Period:
            ...
            <section class="section_2">
                <table>
                    <tr style=" color:white;">
                        <th style="padding:0 !important; width:40%;font-weight:400;">SSN:
                            XXX-XX-{{ $requestData['emp_ssn'] }}</th>
            ...
            <section class="tablesection">
                <table class="heading">
                    ...
                    @foreach ($requestData['taxes'] ?? [] as $key => $taxes)
                        <tr>
                            <td></td>
                            <td class="data" id="color" style="line-height:1.6;text-transform:capitalize;">
                                {{ $taxes }}</td>
                    ...
                    <tfoot class="tfooter " style="background:#2dbdab; line-height:1.6;">
                        <tr style="color:white;">
                            ...
                            <th class="tax-align-r" style="height: 47px; font-weight: 100;">
                ...
                <p style="margin-top:10px;">Your Taxes and deductions for this period are
                    {{ $requestData['currency'] }}
