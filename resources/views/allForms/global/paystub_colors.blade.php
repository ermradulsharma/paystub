        ...
        <section class="invoiceborder">
            ...
            <section class="section_2">
                <table>
                    <tr style=" color:white;">
                        <th style="padding:0 !important; width:40%;font-weight:400;">SSN: XXX-XX-{{
                            $requestData['emp_ssn'] }}</th>
                        <th class="earning" style="padding:0; font-weight:400; width:60%">{{ $requestData['emp_name'] }}
                        </th>
                    </tr>
                    <tr style="color:white">
            ...
            <section class="tablesection">
                <table>
                    <tr>
                        ...
                        <td class="heading1" style="text-align:right;">This Period</td>
                    ...
                    <tr>
                        ...
                        <td class="heading2" style="text-align:right;">{{ $requestData['currency'] }} {{
                    ...
                    <tfoot class="tfooter" style="background:#2dbdab;">
                        <tr style=" color:white; height:20%;">
                            ...
                            <th class="tax-align-c"
                                style="font-weight: 100; height: 47px; padding-right: 0px;text-align:right;"> {{
                                $requestData['currency'] }} {{ number_format($requestData['period_gross_total'],2) }}
                            </th>
                            <th class="tax-align-r" style="font-weight: 100; height: 47px">{{ $requestData['currency']
            ...
            <section class="tablesection">
                <table class="heading">
                    ...
                    <tr>
                        <td></td>
                        <td class="data" id="color" style="line-height:1.6;text-transform:capitalize;">{{ $taxes }}</td>
                        <td class="tax-align-r" id="color">{{ $requestData['currency'] }} {{
                            number_format($requestData['taxes_rate'][$key],2) }} </td>
                        <td class="tax-align-r" id="color" style="line-height:1.6">{{ $requestData['currency'] }} {{
                    ...
                    <tfoot class="tfooter " style="background:#2dbdab; line-height:1.6;">
                        <tr style="color:white;">
                            ...
                            <th class="tax-align-r" style="height: 47px; font-weight: 100;">{{ $requestData['currency']
