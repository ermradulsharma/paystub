            ...
            <div class="container" style=" margin-top:100px; width:100%; padding:0px 20px;">
                <div class="row" style="display: flex;justify-content: space-between;padding: 0px 14px;">
                    ...
                    <div style="width: 50%;float:right;">
                        <h6 @if($requestData['address_2'] != '')style="text-align:left; left:80px; position: relative; top:10px;font-weight:400;font-size: 14px;"@else style="text-align:left; left:80px; position: relative;  top:30px;font-weight:400;font-size: 13px;"@endif>{{ $requestData['check_no'] }} </h6>
                        <h6 @if($requestData['address_2'] != '')style="font-size: 14px; text-align:left; bottom:25px; left:80px; position: relative; font-weight:400;"@else style="font-size: 13px; text-align:left; left:80px; position: relative; font-weight:400;"@endif>{{ date('m/d/Y', strtotime($requestData['pay_date'])) }}</h6>
                    </div>
                </div>
