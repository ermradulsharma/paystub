                ...
                <table style="width: 34%;  float:right; border:3px solid #0054ff; border-radius:7px; margin-top: -138px; height:150px;background: white;padding-left:10px;">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; font-size:16px; padding-right:10px;font-family: 'Myriad Pro', sans-serif; line-height: 90%;"><b>{{ number_format($requestData['employee_nic'],2) }}</b></td>
                        </tr>
                        <tr>
