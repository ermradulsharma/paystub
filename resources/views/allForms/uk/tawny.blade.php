    ...
    @endauth
        ...
        <section style="width: 100%;background-color: #ffdfdf;  padding-top:30px;padding-bottom:60px;">
            ...
            <section style="width:100%;">
                <table style="width: 29.3%; float:left; border:3px solid #fe0000; border-radius:7px; margin-top:150px; height:120px;margin-left:20px;position: relative; right:14px; padding-top:10px; margin-bottom:300px;background: white;">
                   <thead>
                       <tr>
            ...
            <section style="width: 100%;">
                ...
                <table style="width: 34%;  float:right; border:3px solid #fe0000;   border-radius:7px; margin-top: -138px; height:150px;background: white;padding-left:10px;">
                    <thead>
                        ...
                        <tr>
                            <td style="font-size:16px;font-family: 'Myriad Pro', sans-serif;line-height:85%;">Income Tax</td>
                            <td style="text-align: right; font-size:16px; padding-right:10px;font-family: 'Myriad Pro', sans-serif;line-height:85%;"><b>{{ number_format($requestData['income_tax'],2) }}</b></td>
                        </tr>
                        <tr>
                            <td style="font-size:16px;font-family: 'Myriad Pro', sans-serif;line-height:85%;">Employee NIC</td>
                            <td style="text-align: right; font-size:16px; padding-right:10px;font-family: 'Myriad Pro', sans-serif;line-height:85%;"><b>{{ number_format($requestData['employee_nic'],2) }}</b></td>
                        </tr>
                        <tr>
                            <td style="font-size:16px;font-family: 'Myriad Pro', sans-serif;line-height:85%;">Employer NIC</td>
                            <td style="text-align: right; font-size:16px; padding-right:10px;font-family: 'Myriad Pro', sans-serif;line-height:85%;"><b>{{ number_format($requestData['employer_nic'],2) }}</b></td>
                        </tr>
                    </thead>
                </table>
            </section>
            <section style="width: 100%;">
                <table style="width:64%; border:3px solid #fe0000;  border-radius:7px;margin-top:25px;position:relative; left:6px;background: white;">
                ...
                <table style="width:34%; float:right; border:3px solid #fe0000; border-radius:7px; text-align: left;margin-top: -62px; margin-right: 5px;background: white;">
                    <thead style="">
