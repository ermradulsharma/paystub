...
<body>
    <main class="bg-img2">
        ...
        <section style="width: 100%;background-color: #efefef; padding-top:30px;padding-bottom:60px;">
            ...
            <section style="width: 100%;">
                <table style="width:64%; border:3px solid #6c6c6c;  border-radius:7px;margin-top:25px;position:relative; left:6px;background: white;">
                ...
                <table style="width:34%; float:right; border:3px solid #6c6c6c; border-radius:7px; text-align: left;margin-top: -62px; margin-right: 5px;background: white;">
                    <thead style="">
