    ...
    <main class="bg-img2">
        ...
        <section style="width: 100%; background-color: #efefef; padding-top:30px;padding-bottom:60px;">
            <section style="width: 100%; margin-top:20px;">
                <table style="width: 99%; border:1px solid #6c6c6c; padding:5px; margin-left:5px; margin-right:5px; border-radius:7px;background: white;">
                    <thead>
                        <tr>
            ...
            <section style="width:100%;">
                <table style="width: 27%; float:left; border:1px solid #6c6c6c; border-radius:7px; margin-top:150px; height:120px;margin-left:20px;padding-left:20px; padding-top:10px; margin-bottom:300px;background: white;">
                    <thead>
                        <tr>
                ...
                <table style="width: 34%; float:right;  border:1px solid #6c6c6c; border-radius:7px; margin-top:10px; margin-left:6px;margin-right:6px;height:359px; background: white;padding-left:10px;">
                    <thead>
                        <tr>
                ...
                <table style="width: 34%; float:right; border:1px solid #6c6c6c; border-radius:7px; margin-top:10px;margin-bottom:20px; padding-left:10px; height:200px; background: white;">
                    <thead>
                        <tr>
                            <td>Pay Period</td>
                            <td><b>wk 39</b></td>
            ...
            <section style="width: 100%;">
                ...
                <table style="width: 34%;  float:right; border:1px solid #6c6c6c; border-radius:7px; margin-top: -145px; height:150px;background: white;padding-left:10px;">
                    <thead>
                        <tr>
            ...
            <section style="width: 100%;">
                <table style="width:60%; border:1px solid #6c6c6c; border-radius:7px;margin-top:13px; margin-left:35px;background: white;">
                    <thead style="text-align:left; border-radius:7px;">
                        <td style="padding: 15px;">Additional Information Here (Note)</td>
                    </thead>
                </table>

                <table style="width:34%; float:right; border:1px solid #6c6c6c; border-radius:7px; text-align: left;margin-top: -52px;
