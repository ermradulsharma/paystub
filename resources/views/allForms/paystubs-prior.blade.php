...
<table style="width: 100%;">
    <tr style="">
        <td style="font-size:18px; font-weight:800;">Paystubx</td>
        <td ></td>
        <td >No: 17658</td>
    </tr>
    <tr>
       <td>1701 leagacy Dr Ste  470</td>
    </tr>
    <tr>
       <td>Frisco, TX 75034<td>
        <td>Date: 12/13/2023</td>
    </tr>
    <tr>
        <td>Pay TO The</td>
        <td style="border-bottom: 1px solid black; ">Ezra Pinkett</td>
    </tr>
    <tr>
        <td>Order Of</td>
        <td style="border-bottom: 1px solid black;padding-top:20px;">Seven Thousand One Hundred Forty-Five and 63/100</td>
        <td>$  **7.145.63</td>
    </tr>
</table>
...
<table style="width: 100%; padding-top:60px;">
    ...
    <tr>
        <td>Memo: </td>
        <td colspan="2">FOR RECORDS PURPOSES ONLY</td>
       
        <td style="border-bottom: 1px solid black;" >-------------------</td>
    </tr>
    <tr >
        <td></td>
        <td style=" padding-top:30px;">98745687T58T43098584598</td>
    </tr>
</table>
