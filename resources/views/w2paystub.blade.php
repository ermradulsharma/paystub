                    ...
                    <div class="bottom-outer">
                        <div class="bottom-box-outer">
                            ...
                            <div class=" bottom-box-inner">
                                ...
                                <input name="employee_state_id" style="border:1px solid black; text-align:center;" class="input" type="number" placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner">
                                <p style="padding:0; margin:0px;" class="color-red"><b>16 </b> State Wages, tips etc.
                                </p>
                                <input name="state_wages" style="border:1px solid black;" class="input" type="number" placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner">
                                <p style="padding:0; margin:0px;" class="color-red"><b>17 </b>State income tax </p>
                                <input name="state_income_tax" style="border:1px solid black;" class="input" type="number" placeholder="Please Enter">
                            </div>
                        </div>
