                        ...
                        <div class="w2form-box-outer">
                            <div class="w2form-left-box">
                                ...
                                <div class="bottom-textarea">
                                    <textarea name="emp_address" class="w2-textarea" style="padding-left:10px;" id="w3review" name="w3review"
                                        rows="6" cols="83" placeholder="Please Enter"></textarea>
                            ...
                            <div class="w2form-right-box">
                                <div class="input-box2-outer">
                                    ...
                                    <div class="inputbox2">
                                        <p style="padding:0; margin:0px;" class="color-red"><b>2</b> Federal income tax
                                            withheld</p>
                                        <input name="federal_tax" class="input" type="number"
                                            placeholder="Please Enter">
                                    </div>
                                </div>
                                <div class="input-box2-outer">
                                ...
                                <div class="input-box2-outer">
                                    <div class="inputbox2">
                                        <p style="padding:0; margin:0px;" class="color-red"><b>5</b> Medicare wages and
                                            tips</p>
                                        <input name="medicare_wages" class="input" type="number"
                                            placeholder="Please Enter">
                                    ...
                                    <div class="inputbox2">
                                        <p style="padding:0; margin:0px;" class="color-red"><b>6 </b> Medicare tax
                                            withheld</p>
                                        <input name="medicare_tax" class="input" type="number"
                                            placeholder="Please Enter">
                                ...
                                <div class="input-box2-outer">
                                    ...
                                    <div class="inputbox2">
                                        ...
                                        <input name="allocated_tips" class="input" type="number"
                                            placeholder="Please Enter">
                                ...
                                <div style="" class="input-box2-outer">
                                    ...
                                    <div class="inputbox2">
                                        <p style="padding:0; margin:0px;" class="color-red"><b>10 </b> Dependent care
                                            benefits</p>
                                        <input name="dependent_care" class="input" type="number"
                                            placeholder="Please Enter">
                                ...
                                <div class="input-box2-outer">
                                    <div class="inputbox2">
                                        ...
                                        <input name="nonqualified" class="input" type="number"
                                            placeholder="Please Enter">
                                    ...
                                    <div class="inputbox2">
                                        ...
                                        <div class="display">
                                            <div class="checkbox-inner">
                                                <input class="checkbox-sqaure statutory_emp" type="checkbox"
                                                    id="vehicle1" name="statutory_emp" value="false">
                                                <p style="padding:0; margin:0px; font-size:12px;line-height:1.2;"
                                                    class="color-red"><b style="font-size: 10px;">Statutory employee</b>
                                                </p>
                                            </div>
                                            <div class="checkbox-inner">
                                                <input class="checkbox-sqaure retirement_plan" type="checkbox"
                                                    id="vehicle1" name="retirement_plan" value="false">
                                                <p style="padding:0; margin:0px; font-size:12px;line-height:1.2;"
                                ...
                                <div style="border-bottom:none !important;" class="input-box2-outer">
                                    <div class="inputbox2">
                                        ...
                                        <textarea class="bottom-textarea1" style="padding-left:10px;" id="w3review" name="other" rows="5"
                        ...
                        <div class="bottom-outer">
                            ...
                            <div class="bottom-box-outer">
                                ...
                                <div class=" bottom-box-inner1">
                                    ...
                                    <input name="locality_name" style="border:1px solid black;" class="input"
                                        type="text" placeholder="Please Enter">
                                </div>
                            </div>
                        </div>
