                ...
                <div class="rec-box-border">
                    <div style="border-bottom:2px solid red;" class="row">
                        ...
                        <div class="input-feild-outer">
                            ...
                            <input name="company_ssn" style="text-align: center" type="number"
                    ...
                    <div class="w2form-box-outer">
                        <div class="w2form-left-box">
                            ...
                            <div style="" class=" textarea-w2 textarea-outer">
                                <p style="margin:0; padding:0px;margin-left:10px !important;" class="color-red"><b>c</b>
                                    Employer's name, address, and Zip code</p>
                                <textarea name="company_address" class="w2-textarea" style="padding-left:10px;"
                                    id="w3review" name="w3review" rows="5" cols="80"
                            ...
                            <div class="inputbox-outer">
                                <div class="input-box  width">
                                    ...
                                    <input name="emp_first_name" class="input"
                                ...
                                <div style="margin-left:10px !important;margin-right:0px !important;"
                                    class="input-box  width ">
                                    <p style="margin:0; padding:0px;" class="color-red"> Last Name</p>
                                    <input name="emp_last_name" class="input"
                                        style="text-align: left;margin:0px;  padding-left:10px !important;" type="text"
                                        placeholder="Please Enter">
                                </div>
                                <div class="text">
                            ...
                            <div class="bottom-textarea">
                                <textarea name="emp_address" class="w2-textarea" style="padding-left:10px;"
                                    id="w3review" name="w3review" rows="6" cols="83"
                                    placeholder="Please Enter"></textarea>
                        ...
                        <div class="w2form-right-box">
                            ...
                            <div class="input-box2-outer">
                                ...
                                <div class="inputbox2">
                                    <p style="padding:0; margin:0px;" class="color-red"><b>12a </b> See instructions
                                        for box 12</p>
                                    <div class="pie-box-outer">
                                        <span><img style="width:9px;" src="{{ asset('images/code.png') }}"></span>
                                        <input name="pie_1" class="pie-box input" type="text" placeholder="PIE"
                                            maxlength="3">
                                        <input name="instructions_box_1" class="input-pie-box input" type="number"
                                            placeholder="Please Enter">
                                    </div>
                                </div>
                            </div>
                            <div class="input-box2-outer">
                                <div class="inputbox2">
                                    <div style="width:100% !important;" class="checkbox-inner">
                                        <p style="padding:0; margin:0px;line-height:1.2; text-align:left !important;"
                                            class="color-red"> <b>13</b> </p>
                                    </div>
                                    <div class="display">
                                        <div class="checkbox-inner">
                                            <input class="checkbox-sqaure statutory_emp" type="checkbox" id="vehicle1"
                                                name="statutory_emp" value="false">
                                            <p style="padding:0; margin:0px; font-size:12px;line-height:1.2;"
                                                class="color-red"><b style="font-size: 10px;">Statutory employee</b>
                                            </p>
                                        </div>
                                        <div class="checkbox-inner">
                                            <input class="checkbox-sqaure retirement_plan" type="checkbox" id="vehicle1"
                                                name="retirement_plan" value="false">
                                            <p style="padding:0; margin:0px; font-size:12px;line-height:1.2;"
                                                class="color-red"><b style="font-size: 10px;">Retirement plan</b></p>
                                        </div>
                                        <div class="checkbox-inner">
                                            <input class="checkbox-sqaure third_party_sick" type="checkbox"
                                                id="vehicle1" name="third_party_sick" value="false">
                                            <p style="padding:0; margin:0px; font-size:12px;line-height:1.2;"
                                                class="color-red"><b style="font-size: 10px;">Third party sick pay</b>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="inputbox2">
                                    ...
                                    <div class="pie-box-outer">
                                        <span><img style="width:9px;" src="{{ asset('images/code.png') }}"></span>
                                        <input name="pie_2" class="pie-box input" type="text" placeholder="PIE"
                                            maxlength="3">
                                        <input name="instructions_box_2" class="input-pie-box input" type="number"
                                            placeholder="Please Enter">
                                    </div>
                                </div>
                            </div>
                            <div style="border-bottom:none !important;" class="input-box2-outer">
                                <div class="inputbox2">
                                    ...
                                    <textarea class="bottom-textarea1" style="padding-left:10px;" id="w3review"
                                        name="other" rows="5" cols="80" placeholder="Please Enter"></textarea>
                                </div>
                                <div class="inputbox2">
                                    <div class="input-box2-inner">
                                        ...
                                        <div class="pie-box-outer">
                                            <span><img style="width:9px;" src="{{ asset('images/code.png') }}"></span>
                                            <input name="pie_3" class="pie-box input" type="text" placeholder="PIE"
                                                maxlength="3">
                                            <input name="instructions_box_3" class="input-pie-box input" type="number"
                                                placeholder="Please Enter">
                                        </div>
                                    </div>
                                    <div class="input-box2-inner">
                                        ...
                                        <div class="pie-box-outer">
                                            <span><img style="width:9px;" src="{{ asset('images/code.png') }}"></span>
                                            <input name="pie_4" class="pie-box input" type="text" placeholder="PIE"
                                                maxlength="3">
                                            <input name="instructions_box_4" class="input-pie-box input" type="number"
                                                placeholder="Please Enter">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bottom-outer">
                        <div class="bottom-box-outer">
                            ...
                            <div class=" bottom-box-inner">
                                ...
                                <input name="state_wages" style="border:1px solid black;" class="input" type="number"
                                    placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner">
                        ...
                        <div class="bottom-box-outer">
                            <div class=" bottom-box-inner1">
                                <p style="padding:0; margin:0px; text-align:left;" class="color-red"><b>18 </b> Local
                                    Wages, tips, etc.
                                </p>
                                <input name="local_wages" style="border:1px solid black;" class="input" type="number"
                                    placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner1">
                            ...
                            <div class=" bottom-box-inner1">
                                ...
                                <input name="locality_name" style="border:1px solid black;" class="input" type="text"
                                    placeholder="Please Enter">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container" style="max-width: 1452px;">
                    <div class="row">
                        <div class=" col-md-6 padding">
                            <p class="w2p"> Form <span style="font-size: 47px;">W-2</span> <span
                                    style="font-size: 26px;"> Wage and Tax Statement</span> </p>
                            <p class="w2p">
                                <span style="font-size: 18px; font-weight: 900;">Copy A-For Social Security
                                    Administration.</span>
                                <span style="font-weight: 500; font-size: 17px;"> Send this entire page with Form W-3
                                    to the Social Security Administration; photocopies are<b> not</b> acceptable.</span>
                            </p>
                        </div>
                        <div class="col-md-2">
