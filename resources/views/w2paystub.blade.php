                ...
                <div class="rec-box-border">
                        ...
                        <div class="w2form-right-box">
                            <div class="input-box2-outer">
                                ...
                                <div class="inputbox2">
                                    ...
                                    <input name="federal_tax" class="input" type="text" placeholder="Please Enter">
                                </div>
                            </div>
                            <div class="input-box2-outer">
                                <div class="inputbox2">
                            ...
                            <div class="input-box2-outer">
                                <div class="inputbox2">
                                    ...
                                    <input name="medicare_wages" class="input" type="text" placeholder="Please Enter">

                                </div>
                                <div class="inputbox2">
                                    <p style="padding:0; margin:0px;" class="color-red"><b>6 </b> Medicare tax withheld</p>
                                    <input name="medicare_tax" class="input" type="text" placeholder="Please Enter">
                            ...
                            <div class="input-box2-outer">
                                ...
                                <div class="inputbox2">
                                    ...
                                    <input name="allocated_tips" class="input" type="text" placeholder="Please Enter">
                            ...
                            <div style="" class="input-box2-outer">
                                ...
                                <div class="inputbox2">
                                    ...
                                    <input name="dependent_care" class="input" type="text" placeholder="Please Enter">
                            ...
                            <div class="input-box2-outer">
                                <div class="inputbox2">
                                    ...
                                    <input name="nonqualified" class="input" type="text" placeholder="Please Enter">
                                ...
                                <div class="inputbox2">
                                    ...
                                    <div class="pie-box-outer">
                                        ...
                                        <input name="instructions_box_1" class="input-pie-box input" type="text" placeholder="Please Enter">
                                    </div>
                            ...
                            <div class="input-box2-outer">
                                <div class="inputbox2">
                                    ...
                                    <div class="display">
                                        ...
                                        <div class="checkbox-inner">
                                            ...
                                            <p style="padding:0; margin:0px; font-size:12px;line-height:1.2;" class="color-red"><b style="font-size: 10px;">Statury employee</b></p>
                                        </div>
                                        <div class="checkbox-inner">
                                        ...
                                        <div class="checkbox-inner">
                                            <input class="checkbox-sqaure" type="checkbox" id="vehicle1" name="third_party sick" value="Bike">
                                ...
                                <div class="inputbox2">
                                    ...
                                    <div class="pie-box-outer">
                                        ...
                                        <input name="instructions_box_2" class="input-pie-box input" type="text" placeholder="Please Enter">
                                    </div>
                                ...
                                <div class="inputbox2">
                                    <div class="input-box2-inner">
                                        ...
                                        <div class="pie-box-outer">
                                            ...
                                            <input name="instructions_box_3" class="input-pie-box input" type="text" placeholder="Please Enter">
                                        </div>
                                    ...
                                    <div class="input-box2-inner">
                                        ...
                                        <div class="pie-box-outer">
                                            ...
                                            <input name="instructions_box_4" class="input-pie-box input" type="text" placeholder="Please Enter">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="bottom-outer">
                        <div class="bottom-box-outer">
                            ...
                            <div class=" bottom-box-inner">
                                <p style="padding:0; margin:0px;" class="color-red"><b></b>Employess's state id number </p>
                                <input name="employee_state_id" style="border:1px solid black; text-align:center;" class="input" type="text" placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner">
                                <p style="padding:0; margin:0px;" class="color-red"><b>16 </b> State Wages, tips etc. </p>
                                <input name="state_wages" style="border:1px solid black;" class="input" type="text" placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner">
                                <p style="padding:0; margin:0px;" class="color-red"><b>17 </b>State income tax </p>
                                <input name="state_income_tax" style="border:1px solid black;" class="input" type="text" placeholder="Please Enter">
                            </div>
                        </div>
                        ...
                        <div class="bottom-box-outer">
                            <div class=" bottom-box-inner1">
                                ...
                                <input name="local_wages" style="border:1px solid black;" class="input" type="text" placeholder="Please Enter">

                            </div>
                            <div class=" bottom-box-inner1">
                                <p style="padding:0; margin:0px;" class="color-red"><b>19 </b> Local Income Tax </p>
                                <input name="local_income_tax" style="border:1px solid black;" class="input" type="text" placeholder="Please Enter">
                            </div>
                            <div class=" bottom-box-inner1">
