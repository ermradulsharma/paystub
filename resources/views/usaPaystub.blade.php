        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body card-body">
                    <embed src="" type="" id="tempView" allowtransparency="false" style="background-color : white; border: none;" frameborder="0" width="100%" height="800">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3 mt-4">
                                    <div>
                                        ...
                                        <input type="number" step="0.5" id="hourly" name="hourly" placeholder="Wage" class="w-100   input-box-font hourly">
                                    </div>
                                </div>
                                <div class="col-md-3 mt-4">
                                    <div>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div>
                                        <label for="exemptions" class="lable">EXEMPTIONS</label>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div>
                                        <label for="currency" class="lable" class="redColor" style="color: red;">SELECT YOUR PREFERRED CURRENCY </label>
                        ...
                        <div class=" box-usa">
                            <div class="row mb-3">
                                <div class="col-md-3 mt-4">
                                    <div>
                                        ...
                                        <input style="color:#140303f5;border:1px solid #110303fe; !important;  appearance: none;" type="text" id="pay_start" name="pay_start" placeholder="12-11-2022" class="w-100 p-2 input-box-font removeDiv pay_start datepicker inputdatepicker input-box-font"data-id="pay_start" value="<?php echo date('mm/dd/yyyy'); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div>
                                        ...
                                        <input style="color:#140303f5;border:1px solid #110303fe;  appearance: none;" type="text" id="pay_end" name="pay_end" placeholder="12-17-2022" class="w-100 p-2 input-box-font removeDiv pay_end datepicker inputdatepicker input-box-font" data-id="pay_end" value="<?php echo date('mm/dd/yyyy', strtotime('+7 days')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mt-4">
                                    <div>
                                        ...
                                        <input style="color:#140303f5; appearance: none; border:1px solid #110303fe;" type="text" id="pay_date" name="pay_date" placeholder="12-19-2022" class="w-100 p-2 input-box-font removeDiv pay_date datepicker inputdatepicker input-box-font" data-id="pay_date" value="<?php echo date('mm/dd/yyyy'); ?>">
                                    </div>
                                </div>
                                <div class="col-md-3 mt-4">
                                    <div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-2  col-md-2 margin-bottom mt-2  ">
                                    ...
                                    <div class="margin-bottom">
                                        <input type="number" name="rate[]" class="earnbtn removeData mt-4 mb-3 text-center calculation rate" id="rate_0" data-id="0">
                                    </div>
                                    <div id="addRate"></div>
                                </div>
                                <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                    ...
                                    <div class="margin-bottom">
                                        <input type="number" name="hours[]" class="earnbtn removeData mt-4 mb-3 text-center hours calculation" id="hours_0" data-id="0">
                                    </div>
                                    <div id="addHours"></div>
                                </div>
                                <div class=" col-lg-2 col-md-2 margin-bottom mt-2  ">
                            ...
                            <div class=" col-lg-2 col-md-2 margin-bottom">
                                <input type="hidden" name="deduction_period_tax" class="earnbtn text-center deduction_period_tax" id="deduction_period_tax" hidden>
                                <input type="hidden" name="deduction_period_tax_other" class="earnbtn text-center deduction_period_tax_other" id="deduction_period_tax_other" hidden>
                            </div>
                            <div class=" col-lg-2 col-md-2 margin-bottom">
                                <input type="hidden" name="" class="earnbtn text-center ytd_deduction_period_tax" id="ytd_deduction_period_tax" hidden>
                                <input type="hidden" name="" class="earnbtn text-center ytd_deduction_period_tax_other" id="ytd_deduction_period_tax_other" hidden>
                            </div>
                            <div class="row my-3">
                                <div class="col-md-4 col-lg-3">
                                    <button type="button" class="add_deduction earnbtn" style="font-size: 18px;"><i class="fa fa-plus-circle pr-lg-5 pr-2" style="font-size:24px;color:green"></i>Add Deduction</button>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="row mb-3 advice">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-sm-6 mb-2 advicex advicexv advicexvc d-none">
                                        <div>
                                            ...
                                            <input type="text" name="client_no" id="client_no" class="earnbtn removeDiv text-center" placeholder="12345" maxlength="5" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                        </div>
                                    </div>
