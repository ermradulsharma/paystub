                        ...
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_id" name="emp_id" placeholder="Employee Id" class="w-100  input-box-font removeDiv" maxlength="5" minlength="5" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div class="row">
