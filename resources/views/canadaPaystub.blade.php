                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box-usa">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div>
                                            <label for="city" class="lable">City <span
                                                    class="redColor">*</span></label>
                                    ...
                                    <div class="col-md-4 mt-4">
                                        <div>
                                            ...
                                            <input type="text" id="emp_name" name="emp_name"
                                                placeholder="Employee name" class="w-100  input-box-font removeDiv">
                                        </div>
                            ...
                            <div class=" box-usa">
                                    ...
                                    <div class="col-lg-5 pl-0">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 mb-4 col-md-4 pr-0 addtaxes_rate">
                                                <button type="button" class="statementbtn">CURRENT TOTAL</button>
                                                @foreach ($deduction as $key => $item)
                                                    <input type="number" class="earnbtn text-center mt-3"
                                            ...
                                            <div class="col-lg-4 mb-4 col-md-4 pr-0 addtaxes_ytd">
                                                ...
                                                @foreach ($deduction as $key => $item)
                                                    <input type="number" class="earnbtn text-center mt-3"
                                                        name="taxes_ytd[]" id="tax_ytd_00{{ $key }}">
                                                @endforeach
                                            </div>
                                        </div>
                                        <div class="row my-2">
                                ...
                                <div class="row mb-3 mt-4 mt-lg-5">
                                    ...
                                    <div class="col-lg-2 col-md-2 mb-2">
                                        ...
                                        <input type="number" class="earnbtn text-center mt-3" id="net_pay"
                                            name="total_net_pay">
                                    </div>
                                </div>
                            </div>
