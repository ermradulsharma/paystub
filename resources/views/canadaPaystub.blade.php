                    ...
                    <div class="box-usa">
                        <div class="row mb-3 mt-3">
                            <div class="col-md-6 mt-1">
                                <div class="">
                                    <label for="cname" class="lable em-name">EMPLOYER (COMPANY) NAME <span class="redColor">*</span>
                                    </label>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6 px-0">
                                        <div>
                                            ...
                                            <input style="color:#00000080; border-radius:2px 0px 0px 2px;border:1px solid #00000080; border-right:none;padding:0px 6px !important; height:40px; appearance: none;" type="date" id="pay_start" name="pay_start" placeholder="12-11-2022" class="w-100 py- input-box-font pay_start datepicker" data-id="pay_start" style="border: 1px solid #878080;border-right: none;">
                                        </div>
                                    </div>
                                    <div class="col-6 px-0">
                                        <div>
                                            <label for="pay_end" class="lable"> <span class="redColor"></span></label>
                                            <input style="color:#00000080; border-radius:0 2px 2px 0;border:1px solid #00000080;padding:0px 6px !important; height:40px; appearance: none; border-left:none;" type="date" id="pay_end" name="pay_end" placeholder=" " class="w-100 py- input-box-font pay_end" data-id="pay_end" style="border: 1px solid #878080;border-left: none;" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input style="color:#00000080;border:1px solid #00000080; padding:0px 6px !important; height:40px; appearance: none;" type="date" id="pay_date" name="pay_date" placeholder="12-19-2022" class="w-100 p- input-box-font pay_date" data-id="pay_date">
                                </div>
                            </div>
                        </div>
