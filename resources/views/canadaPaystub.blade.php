                    ...
                    <div class=" box-usa">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4 mt-4">
                                ...
                                <div class="col-md-4 mt-4">
                                    <div>
                                        <label for="emp_ssn" class="lable">PAY DATE <span class="redColor">*</span>
                                        </label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div>
                                        <label for="emp_zip_code" class="lable">EMPLOYER NAME <span
                                                class="redColor">*</span>
                                        </label>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div class="col-lg-11">
                                                        <input class="earnbtn text-center taxes" name="taxes[]"
                                                            data-id="0" data-value="1.46" value="FICA - Medicare">
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb- d-flex" style="justify-content: space-between;">
                            <div class="text-left mt-1 ">
                                <button class="previewbtn text-capitalize viewTempTemplate"> Preview Your Paystub <i
                                        class="fa fa-eye" style="font-size: 30px; margin-left: 7px;"></i></button>
                            </div>
