                    ...
                    <div class=" box-usa">
                        <div class="d-flex justify-content-between mb-3 flex w-100">
                            ...
                            <div class="col-md-5 col-lg-6 col-sm-10 mt-5 text-center margin-right">
                                ...
                                <div class=" mt-3 ">
                                    <button class="viewbtn"> <a style="color: #010101;"
                            ...
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_ssn" name="emp_ssn" placeholder="SSN (Last 4 digits)"
                                        class="w-100 input-box-font" maxlength="4" minlength="4"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <input type="text" step="0.5" id="hourly" name="hourly" placeholder="Hourly"
                                        class="w-100 input-box-font hourly" value="">
                                </div>
                            </div>
                            <div class="col-md-3 mt-4">
                                <div>
                    ...
                    <div class=" box-usa">
                            ...
                            <div class="col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom">
                                    <input type="text" name="rate[]"
                                        class="earnbtn removeData mt-4 mb-3 text-center calculation rate" value=""
                                        id="rate_0" data-id="0">
                                </div>
                                <div id="addRate"></div>
                            </div>
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom">
                                    <input type="text" name="hours[]"
                                        class="earnbtn removeData mt-4 mb-3 text-center hours calculation" value=""
                        ...
                        <div class=" col-lg-2 col-md-2 margin-bottom">
                            <input type="text" name="period_gross_total" class="earnbtn text-center period_gross_total"
                                value="" id="period_gross_total" hidden>
                        </div>
                        <div class=" col-lg-2 col-md-2 margin-bottom">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-3 mb-3">
                                ...
                                <input class="earnbtn text-center taxes" name="taxes[]" data-id="{{ $key }}"
                                    data-value="{{ $item->price }}" value="{{ $item->title }}"
                                    data-value="{{ $item->title }}" data-text="{{ $item->type }}">
                            </div>
                            <div class="col-md-1 col-lg-1"></div>
                            <div class="col-md-2 col-lg-3"></div>
                            <div class="col-md-1 col-lg-1"></div>
                            <div class="col-md-2 col-lg-2 mb-3">
                                <input type="text" name="taxes_rate[]" class="earnbtn text-center manualTaxTotal"
                                    id="taxes_{{ $key }}" value="" data-value="" />
                            </div>
                            <div class="col-md-2 col-lg-2 mb-3">
                                <input type="text" name="taxes_ytd[]" class="earnbtn text-center manualTaxTotal"
                                    id="taxes_ytd_{{ $key }}" value="" data-value="" />
                            </div>
                        </div>
                        @endforeach
                        <div id="add_deduction" class="mb-3"></div>
                        <div class=" col-lg-2 col-md-2 margin-bottom">
                            <input type="text" name="" class="earnbtn text-center deduction_period_tax" value=""
                                id="deduction_period_tax" hidden>
                            <input type="text" name="" class="earnbtn text-center deduction_period_tax_other" value=""
                                id="deduction_period_tax_other" hidden>
                        </div>
                        <div class=" col-lg-2 col-md-2 margin-bottom">
                            <input type="text" name="" class="earnbtn text-center ytd_deduction_period_tax" value=""
                                id="ytd_deduction_period_tax" hidden>
                            <input type="text" name="" class="earnbtn text-center ytd_deduction_period_tax_other"
                                value="" id="ytd_deduction_period_tax_other" hidden>
                        </div>
                        <div class="row my-3">
                            <div class="col-md-4 col-lg-3">
