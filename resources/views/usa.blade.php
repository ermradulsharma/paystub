                                ...
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        <input type="text" id="emp_street_1" name="emp_street_1"
                                            placeholder="Your Address" class="w-100 p-2  textInputFontSize">
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class=" box-usa">
                            ...
                            <div class="row mb-3 mt-">
                                <div class=" col-lg-2 col-md-2 margin-bottom">
                                    <div>
                                        <input class="earnbtn text-center" type="text" name="earning[]"
                            ...
                            @foreach ($deduction as $key => $item)
                                <div class="row mb-3 mt-4">
                                    ...
                                    <div class="col-md-2 col-lg-2">
                                        <input type="text" name="taxes_rate[]" class="earnbtn text-center"
                                            id="taxes_{{ $key }}" value="" />
                                    </div>
                                    <div class="col-md-2 col-lg-2">
                                        <input type="text" name="taxes_ytd[]" class="earnbtn text-center"
                                            id="taxes_ytd_{{ $key }}" value="" />
                                    </div>
                                </div>
                            @endforeach
                            ...
                            <div class=" col-lg-2 col-md-2 margin-bottom">
                                <input type="text" name="" class="earnbtn text-center deduction_period_tax"
                                    value="" id="deduction_period_tax" hidden>
                            </div>
                            <div class=" col-lg-2 col-md-2 margin-bottom">
                            ...
                            <div class="row my-3">
                                <div class="col-md-4 col-lg-3">
                                    <button type="button" class="add_deduction earnbtn" type="add_deduction"
                                        id="add_deduction"><i class="fa fa-plus-circle pr-5"
                    ...
                    <div class="col-md-12">
                        <div class=" box-usa">
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-6">
                                    <p class="p-0 m-0 text-center" style="font-family: serif;">FILE.<span
            ...
            <div>
                <div class="mb-4 d-flex" style="justify-content: space-between; align-items: center;">
                    ...
                    <div class="text-right mt-1" style="margin-right:30px;">
                        <button type="button"
                            class="emailbtn text-capitalize registerBtn {{ Auth::user() ? 'd-none' : 'd-block' }}"> <i
                                class="fa fa-envelope mr-4" style="font-size:24px"></i>EMAIL PAYSTUB <i
                                class="fa fa-download ml-4" style="font-size:24px"></i></button>
                        <button type="button"
                            class="emailbtn text-capitalize sendMailButton {{ Auth::user() ? 'd-block' : 'd-none' }}"> <i
                                class="fa fa-envelope mr-4" style="font-size:24px"></i>EMAIL PAYSTUB <i
                                class="fa fa-download ml-4" style="font-size:24px"></i></button>
                    </div>
                </div>
