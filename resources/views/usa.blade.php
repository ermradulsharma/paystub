    ...
    <div class="container mt-2" style="max-width:1450px;">
                    ...
                    <div class=" box-usa">
                        ...
                        <div class="row mb-3 ">
                            ...
                            <div class="col-md-6 mt-1">
                                ...
                                <input type="tel" id="tel" name="tel" placeholder="123-234-4565"
                                    class="w-100 p-2 text-center textInputFontSize">
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="state" name="state"
                                    placeholder=" Choose Your Employer State" class="w-100 p-2   textInputFontSize">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-5 col-sm-12 m-auto  text-center" style="padding: -1px 35px;">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="input-group mmenu mb-3 text-center">
                                        <select class="form-control dropdown1 text-center bt_id"
                            ...
                            <div class="col-md-5 col-sm-12 mt-5 text-center">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="input-group mmenu mb-3">
                                        <select class="form-control text-center dropdown1 at_id"
                                            style="border-right:none">
                    ...
                    <div class=" box-usa">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mt-4">
                                <label for="fname" class="lable">EMPLOYEE NAME <span class="redColor">*</span>
                                </label>
                            ...
                            <div class="col-md-4 mt-4">
                                <label for="fname" class="lable">EMPLOYEE SSN last4 <span class="redColor">*</span>
                                </label>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" id="fname" name="fname" placeholder="Your Address"
                                    class="w-100 p-2  textInputFontSize">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" id="fname" name="fname" placeholder=" 1234"
                                    class="w-100 p-2  textInputFontSize">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" box-usa">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 mt-4">
                                <label for="fname" class="lable">SELECT YOUR STATE <span class="redColor">*</span>
                                </label>
                                <div class="dropdown ">
                                    <select name="cars" id="cars" class=" dropdown11">
                            ...
                            <div class="col-md-3 mt-4">
                                <label for="fname" class="lable">AUTO CALCULATOR <span class="redColor">*</span>
                                </label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-4">
                                <label for="fname" class="lable">EMPLOYMENT TYPE <span class="redColor">*</span>
                                </label>
                                <select name="cars" id="cars" class=" dropdown11">
                            ...
                            <div class="col-md-3 mt-4">
                                <label for="fname" class="lable" class="redColor">SELECT YOUR PREFERRED CURRENCY
                ...
                <div class="col-md-12">
                    <div class=" box-usa">
                        <div class="row mb-3">
                            <div class="col-md-3 mt-4">
                                ...
                                <input type="date" id="pay_start" name="pay_start" placeholder="12-11-2022"
                                    class="w-100 p-2 textInputFontSize pay_start" data-id="pay_start">
                            </div>
                            ...
                            <div class="col-md-3 mt-4">
                                <p class="text-center mb-0" style="font-size:18px;">How do you get paid <span
                                        class="redColor">*</span> <span> </p>
                                <div class="text-center mt-2  d-flex justify-content-center">
                                    <button class="hourbtn date_select">HOURLY</button> <button
                                        class="salrybtn">SALARY</button>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3 mt-">
                            <div class="col-md-2">
                                <input class="earnbtn text-center" type="text" value="Regular" id="earning_0"
                                    data-id="0" required>
                            </div>
                            <div class="col-md-2 ">
                                <input type="number" step="0.01" class="earnbtn text-center calculation"
                                    value="" id="rate_0" data-id="0" required>
                            </div>
                            <div class="col-md-2 ">
                                <input type="number" step="0.01" class="earnbtn text-center hours calculation"
                                    value="" id="hours_0" data-id="0" required>
                            </div>

                            <div class="col-md-2">
                                <input type="number" step="0.01" class="earnbtn text-center" value=""
                                    id="total_0" data-id="0" required>
                            </div>
                            <div class="col-md-2">
                                <input type="number" step="0.01" class="earnbtn text-center gross_total"
                                    value="" id="period_0" data-id="0" required>
                            </div>
                            <div class="col-md-2">
                                <input type="number" step="0.01" class="earnbtn text-center ytd_total"
                                    value="" id="ytd_total_0" data-id="0" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2 mt-2 mb-5">
                                <button class="add_button earnbtn"><i class="fa fa-plus-circle pr-2"
                        ...
                        <div class="row my-3">
                            <div class="col-md-4 col-lg-3">
                                <button class="add_deduction earnbtn"><i class="fa fa-plus-circle pr-5"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-1"></div>
                            <div class="col-md-2">
                                <input type="number" step="0.01" class="earnbtn deduction_tax text-center"
                                    value="" />
                            </div>
                            <div class="col-md-2">
                                <input type="number" step="0.01" class="earnbtn ytd_deduction_tax text-center"
                                    value="" />
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class=" box-usa">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                <p class="p-0 m-0 text-center " value="511" style="font-family: serif;">FILE.<span
        ...
        <div class="mb-4 d-flex" style="justify-content: space-between;">
            <div class="text-left mt-1">
                <button class="previewbtn text-capitalize "><a href="{{ 'tempBasic-pdf' }}" target="_blank">Preview Your
                        Paystub </a><i class="fa fa-eye" style="font-size: 30px; margin-left: 7px;"></i></button>
            </div>
            <div class="text-right mt-1">
                <button class="emailbtn text-capitalize" data-toggle="modal" data-target="#myModal"> <i
        ...
        $(document).ready(function() {
            ...
            $(addButton).click(function() {
                var fieldHTML =
                    '<div class="row mb-3">' +
                    '<div class="col-md-2 ">' +
                    '<input  id="earning_' + i + '" data-id="' + i +
                    '" class="earnbtn text-center" value="">' +
                    '</div>' +
                    '<div class="col-md-2 ">' +
                    '<input type="number" step="0.01" id="rate_' + i + '" data-id="' + i +
                    '" class="earnbtn calculation text-center" value="">' +
                    '</div>' +
                    '<div class="col-md-2 ">' +
                    '<input type="number" step="0.01" id="hours_' + i + '" data-id="' + i +
                    '" class="earnbtn calculation text-center hours" value="">' +
                    '</div>' +
                    '<div class="col-md-2">' +
                    '<input type="number" step="0.01" id="total_' + i + '" data-id="' + i +
                    '" class="earnbtn text-center" value="">' +
                    '</div>' +
                    '<div class="col-md-2">' +
                    '<input type="number" step="0.01" id="period_' + i + '" data-id="' + i +
                    '" class="earnbtn gross_total text-center" value="">' +
                    '</div>' +
                    '<div class="col-md-2 ">' +
                    '<input type="number" step="0.01" id="ytd_total_' + i + '" data-id="' + i +
                    '" class="earnbtn ytd_total text-center" value="">' +
                    '</div>' +
                    '</div>';
                if (x < maxField) {
                    x++;
    ...
    <script>
        $(document).ready(function() {
            ...
            function dayCalculate() {
                ...
                var output = dt1.getFullYear() + '-' + (('' + month).length < 2 ? '0' : '') + month + '-' + (('' +
                    day).length < 2 ? '0' : '') + day;
                setTimeout(() => {
                    $(".pay_end").val(output)
                }, 400);
