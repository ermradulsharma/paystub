                            ...
                            <div class="col-md-6 mt-1">
                                <div>
                                    <label for="tel" class="lable">EMPLOYER TELEPHONE NUMBER <span
                                            class="redColor">*</span> </label>
                                    <input type="text" id="tel" name="tel" placeholder="xxx-xxx-xxxx" maxlength="10"
                                        minlength="10" value="{{ $invoice->tel ?? '' }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <input type="text" id="city" name="city" value="{{ $invoice->city ?? '' }}"
                                ...
                                <div>
                                    ...
                                    <div class="dropdown ">
                                        <select name="state" value="{{ $invoice->state ?? '' }}" id="state"
                                            ...
                                            <option value="{{ $stateTax->state }}" {{ $invoice->state ==
                            ...
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_name" name="emp_name" placeholder="Employee Name"
                                        class="w-100  input-box-font removeDiv" value="{{ $invoice->emp_name ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_id" name="emp_id" placeholder="Employer ID"
                                        class="w-100 r input-box-font removeDiv" value="{{ $invoice->emp_id ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_ssn" name="emp_ssn" placeholder="SSN (Last 4 digits)"
                                        class="w-100 input-box-font removeDiv" value="{{ $invoice->emp_ssn ?? '' }}"
                ...
                <div class="col-md-12 px-0">
                    <div class=" box-usa">
                                ...
                                <div>
                                    ...
                                    <div class="dropdown ">
                                        <select name="emp_your_state" id="emp_your_state"
                                            ...
                                            @foreach ($stateTaxes as $stateTax)
                                            <option value="{{ $stateTax->state }}" {{ $invoice->emp_your_state ==
                                                $stateTax->state ? 'selected' : '' }}
                                                data-tax="{{ $stateTax->rate }}">{{ $stateTax->state }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <select name="marital_status" id="marital_status"
                                        ...
                                        <option value="single" {{ $invoice->marital_status == 'single' ? 'selected' : ''
                                            }}>Single
                                        </option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    <label for="emp_type" class="lable">EMPLOYMENT TYPE<span class="redColor">*</span>
                                    </label>
                                    <select name="emp_type" id="emp_type" class=" dropdown11 removeDiv">
                                        <option value=""> --- Select Employment Type --- </option>
                                        <option value="Temporary" {{ $invoice->emp_type == 'Temporary' ? 'selected' : ''
                                            }}>Temporary
                                        </option>
                                        <option value="Permanent" {{ $invoice->emp_type == 'Permanent' ? 'selected' : ''
                                            }}>Permanent
                                        </option>
                                    </select>
                                </div>
                    ...
                    <div class=" box-usa">
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        data-id="pay_start" @if ($invoice->pay_start != '') value="{{
                                    $invoice->pay_start }}" @else value="
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        data-id="pay_end" @if ($invoice->pay_end != '') value="{{ $invoice->pay_end }}"
                                    @else value="
                                    <?php echo date('m/d/Y'); ?>" @endif>
                                </div>
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        data-id="pay_date" @if ($invoice->pay_date != '') value="{{ $invoice->pay_date
                                    }}" @else value="
                                    <?php echo date('m/d/Y'); ?>" @endif>
                                </div>
                        ...
                        <div class="row ">
                            <div class=" col-lg-2 col-md-2 margin-bottom  mt-2">
                                ...
                                <div class="margin-bottom mb-3">
                                    <input class="earnbtn {{ $key == 0 ? 'mt-4' : '' }} text-center" type="text"
                                        name="earning[]" value="{{ $earning ?? null }}" id="earning_00{{ $key }}"
                                        data-id="00{{ $key }}">
                                </div>
                                @endforeach
                            ...
                            <div class="col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3">
                                    <input type="text" name="rate[]"
                                        ...
                                        value="{{ $rate ?? null }}" id="rate_00{{ $key }}" data-id="00{{ $key }}">
                                </div>
                                @endforeach
                                <div id="addRate"></div>
                            </div>
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3">
                                    <input type="text" name="hours[]"
                                        ...
                                        value="{{ $hours ?? null }}" id="hours_00{{ $key }}" data-id="00{{ $key }}">
                                </div>
                                @endforeach
                                <div id="addHours"></div>
                            </div>
                            <div class=" col-lg-2 col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3">
                                    <input type="text" name="total[]"
                                        ...
                                        value="{{ $total ?? null }}" id="total_00{{ $key }}" data-id="00{{ $key }}"
                                        readonly="true">
                                </div>
                                @endforeach
                                <div id="addTotal"></div>
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2">
                                ...
                                <div class="margin-bottom mb-3" style="padding-top: {{ $key == 0 ? '2px' : '' }}">
                                    <input type="text" name="period[]" class="earnbtn  text-center gross_total"
                                        value="{{ $period ?? null }}" id="period_00{{ $key }}" data-id="00{{ $key }}">
                                </div>
                                @endforeach
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3" style="padding-top: {{ $key == 0 ? '2px' : '' }}">
                                    <input type="text" name="ytd_total[]" class="earnbtn  text-center ytd_total"
                                        value="{{ $ytd_total ?? null }}" id="ytd_total_00{{ $key }}"
                                        data-id="00{{ $key }}">
                                </div>
                                @endforeach
                        ...
                        <div class="d-none">
                            <input type="text" name="period_gross_total"
                                ...
                                class="earnbtn text-center period_gross_total" value="" id="period_gross_total" hidden>
                            <input type="text" name="ytd_gross_total" value="{{ $invoice->ytd_gross_total ?? '' }}"
                                class="earnbtn text-center ytd_gross_total" value="" id="ytd_gross_total" hidden>
                        </div>
                        ...
                        <div class="mt-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-lg-2 mb-3">
                                    <input type="text" name="taxes_rate[]" value="{{ $invoice->taxes_rate[$key] ?? 0 }}"
                                        class="earnbtn text-center manualTaxTotal" id="taxes_00{{ $key }}" />
                                </div>
                                <div class="col-md-2 col-lg-2 mb-3">
                                    <input type="text" name="taxes_ytd[]" value="{{ $invoice->taxes_ytd[$key] ?? 0 }}"
                                        class="earnbtn text-center manualTaxTotal" id="taxes_ytd_00{{ $key }}" />
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-lg-3"></div>
                                <div class="col-md-1 col-lg-1"></div>
                                <div class="col-md-2 col-lg-2 mb-3"><input type="text" name="period_tax_deduction[]"
                                        value="{{ $invoice->period_tax_deduction[$key] ?? 0 }}"
                                        class="earnbtn text-center tax_deduction tax" id="taxes_000{{ $key + 1 }}"
                                        data-id="00{{ $key + 1 }}">
                                </div>
                                <div class="col-md-2 col-lg-2 mb-3"><input type="text" name="ytd_tax_deduction[]"
                            ...
                            <div class="d-none">
                                ...
                                <input type="text" name="" class="earnbtn text-center deduction_period_tax_other"
                                ...
                                <input type="text" name="" class="earnbtn text-center ytd_deduction_period_tax"
                                    value="{{ $ytd_deduction_period_tax ?? 0 }}" id="ytd_deduction_period_tax" hidden>
                                <input type="text" name="" class="earnbtn text-center ytd_deduction_period_tax_other"
