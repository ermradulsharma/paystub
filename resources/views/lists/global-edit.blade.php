                    ...
                    <div class="box-usa">
                        <div class="row justify-content py-3">
                            ...
                            <select id="employerAddress" class="address_book add_address address  select-dropdown" data-type="employer">
                                <option data-name="{{ $invoice->cname ?? '' }}" data-address1="{{ $invoice->address_1 ?? '' }}" data-address2="{{ $invoice->address_2 ?? '' }}" data-city="{{  $invoice->city ?? '' }}" data-state="{{ $invoice->state ?? '' }}" data-zip="{{ $invoice->zip_code ?? '' }}" value="">Select Address</option>
                                @foreach ($employerList ?? [] as $key => $employer)
                                <option data-name="{{ $employer->name }}" data-address1="{{ $employer->address_1 }}" data-address2="{{ $employer->address_2 }}" data-city="{{ $employer->city }}" data-state="{{ $employer->state }}" data-zip="{{ $employer->zip_code }}" value="{{ $employer->name }}">{{ $employer->name }}</option>
                                @endforeach
                        ...
                        <div class="row mb-3 ">
                            <div class="col-md-6 mt-1">
                                <div>
                                    ...
                                    <input type="text" id="cname" name="cname" value="{{ $invoice->cname ?? '' }}" placeholder="Your Employer & Company Name" class="w-100 p-2 textInputFontSize removeDiv">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mt-1">
                                <div>
                                    ...
                                    <input type="text" id="tel" name="tel" placeholder="xxx-xxx-xxxx" maxlength="10" minlength="10" value="{{ $invoice->tel ?? '' }}" class="w-100 p-2 text-center input-box-font removeDiv third-phone">
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <input type="text" id="address_1" name="address_1" value="{{ $invoice->address_1 ?? '' }}" placeholder="Your Employer Address" class="w-100 p-2  textInputFontSize removeDiv">
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <input type="text" id="city" name="city" value="{{ $invoice->city ?? '' }}" placeholder="Your Employer City" class="w-100 p-2  textInputFontSize removeDiv">
                                </div>
                            ...
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <div class="dropdown ">
                                        <select name="state" value="{{ $invoice->state ?? '' }}" id="state" class="state dropdown11 removeDiv">
                                            <option value=""> --- Select --- </option>
                                            @foreach ($stateTaxes as $stateTax)
                                            <option value="{{ $stateTax->state_code }}" {{ $invoice->state == $stateTax->state_code ? 'selected' : '' }}> {{ $stateTax->state }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <input type="text" id="zip_code" name="zip_code" placeholder=" Zip Code" class="w-100 input-box-font removeDiv zip_code" value="{{ $invoice->zip_code ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-5 col-lg-6 col-sm-12 mt-5  text-center">
                                ...
                                <div class="mt-4">
                                    <div class="input-group mmenu mb-3 text-center">
                                        <select name="basic_temp" id="basic_temp" class="form-control dropdown1 text-center bt_id small-font basicTemplate removeDiv justify-content-center direction-left" style="margin-right:10px; font-size:18px;">
                                            <option value=""> --- Select Basic Templates --- </option>
                                            @foreach ($basicType as $data)
                                            <option value="{{ $data->title ?? '' }}" {{ $invoice->basic_temp == $data->title ? 'selected' : '' }} data-src="{{ $data->images->file ?? '' }}" data-status="{{ $data->template_element }}" data-stub="{{ $data->stub_no }}" data-check="{{ $data->check_no }}" data-client="{{ $data->client_no }}"> {{ $data->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="mt-4">
                                    <div class="input-group mmenu mb-3">
                                        <select name="advance_temp" id="advance_temp" class="form-control text-center dropdown1 at_id small-font advanceTemplate removeDiv direction-left" style="margin-right:10px; font-size:18px;">
                                            ...
                                            <option value="{{ $data->title ?? '' }}" {{ $invoice->advance_temp == $data->title ? 'selected' : '' }} data-src="{{ $data->images->file ?? '' }}" data-status="{{ $data->template_element }}" data-stub="{{ $data->stub_no }}" data-clock="{{ $data->co_no }}" data-check="{{ $data->check_no }}" data-client="{{ $data->client_no }}"> {{ $data->name ?? '' }} </option>
                                            @endforeach
                                        </select>
                ...
                <div class="col-md-12 px-0">
                    <div class=" box-usa">
                        <div class="row justify-content py-3">
                            ...
                            <img class="address-book" src="{{ asset('images/address-book.png') }}" alt="" height="30px;">
                            <select id="employeeAddress" class="address_book_1 add_address address  select-dropdown" data-type="employee">
                                <option data-name="{{ $invoice->emp_name ?? '' }}" data-address1="{{ $invoice->emp_street_1 ?? '' }}" data-address2="{{ $invoice->emp_street_2 ?? '' }}" data-city="{{ $invoice->emp_city ?? '' }}" data-state="{{ $invoice->emp_state ?? '' }}" data-zip="{{ $invoice->emp_zip_code ?? '' }}" value="">Select Address</option>
                                @foreach ($employeeList ?? [] as $key => $employee)
                                <option data-name="{{ $employee->name }}" data-address1="{{ $employee->address_1 }}" data-address2="{{ $employee->address_2 }}" data-city="{{ $employee->city }}" data-state="{{ $employee->state }}" data-zip="{{ $employee->zip_code }}" value="{{ $employee->name }}"> {{ $employee->name }}</option>
                                @endforeach
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_name" name="emp_name" placeholder="Employee Name" class="w-100  input-box-font removeDiv" value="{{ $invoice->emp_name ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div>
                                    <label for="emp_id" class="lable">EMPLOYEE ID </label>
                                    <input type="text" id="emp_id" name="emp_id" placeholder="Employer ID" class="w-100 r input-box-font removeDiv" value="{{ $invoice->emp_id ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div>
                                    <label for="emp_ssn" class="lable">EMPLOYEE SSN Last 4 <span class="redColor">*</span> </label>
                                    <input type="text" id="emp_ssn" name="emp_ssn" placeholder="SSN (Last 4 digits)" class="w-100 input-box-font removeDiv" value="{{ $invoice->emp_ssn ?? '' }}" maxlength="4" minlength="4" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <input type="text" id="emp_street_1" name="emp_street_1" placeholder="Employee Street Address 1" class="w-100  input-box-font removeDiv" value="{{ $invoice->emp_street_1 ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <input type="text" id="emp_street_2" name="emp_street_2" placeholder="Employee Street Address 2 (optional)" class="w-100  input-box-font" value="{{ $invoice->emp_street_2 ?? '' }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4 stubxc">
                                <div>
                                    ...
                                    <input type="text" id="emp_city" name="emp_city" placeholder="City" class="w-100   input-box-font removeDiv" value="{{ $invoice->emp_city ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 stubxc">
                                <div>
                                    ...
                                    <div class="dropdown ">
                                        <select name="emp_state" id="emp_state" class=" dropdown11 removeDiv">
                                            ...
                                            @foreach ($stateTaxes as $stateTax)
                                            <option value="{{ $stateTax->state_code }}" {{ $invoice->emp_state == $stateTax->state_code ? 'selected' : '' }} data-tax="{{ $stateTax->rate }}">{{ $stateTax->state }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 stubxc">
                                <div>
                                    ...
                                    <input type="text" id="emp_zip_code" name="emp_zip_code" placeholder="Zip Code" class="w-100  input-box-font removeDiv" value="{{ $invoice->emp_zip_code ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 stubxc stubxcv d-none">
                                <div>
                                    <label for="stub_no" class="lable">Stub No <span class="redColor">*</span></label>
                                    <input type="text" id="stub_no" name="stub_no" class="w-100  input-box-font removeDiv" placeholder="1234" maxlength="6" minlength="4" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="{{ $invoice->stub_no ?? '' }}">
                                </div>
                            </div>
                            <div class="col-md-4 stubxc checkxcv d-none">
                                <div>
                                    <label for="check_no" class="lable">Check No <span class="redColor">*</span></label>
                                    <input type="text" id="check_no" name="check_no" class="w-100  input-box-font removeDiv" placeholder="123456789" maxlength="9" minlength="6" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" value="{{ $invoice->check_no ?? '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 px-0">
                    <div class=" box-usa">
                        <div class="row mb-3">
                            <div class="col-md-3 mt-4">
                                ...
                                <div>
                                        ...
                                        <div class="emp_your_state_txt d-none" >
                                            <input type="text" id="emp_your_state" name="emp_your_state_tax" value="{{$invoice->emp_your_state_tax ?? ''}}" placeholder="State" class="w-100 input-box-font tax_rate removeDiv">
                                        </div>
                                        <div class="dropdown emp_your_state_slt">
                                            ...
                                            @foreach ($stateTaxes as $stateTax)
                                            <option value="{{ $stateTax->state_code }}" {{ $invoice->emp_your_state == $stateTax->state_code ? 'selected' : '' }} data-tax="{{ $stateTax->rate }}">{{ $stateTax->state }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <select name="marital_status" id="marital_status" class="dropdown11 marital_status removeDiv  select-dropdown">
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <select name="time_period" id="time_period" class="dropdown11 time_period removeDiv  select-dropdown">
                                        <option value="">Select</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3 mt-4">
                                <div>
                                    <label for="hourly" class="lable">Rate / Unit <span class="redColor">*</span></label>
                                    <input type="text" step="0.5" id="hourly" name="hourly" value="{{ $invoice->hourly ?? '' }}" placeholder="Wage" class="w-100 p-2  textInputFontSize hourly">
                                </div>
                            </div>
                    ...
                    <div class=" box-usa">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <input style="color:#140303f5;border:1px solid #110303fe; padding:0px 6px !important; height:40px; appearance: none;" type="text" id="pay_end" name="pay_end" placeholder="12-17-2022" class="w-100 p-2 input-box-font removeDiv pay_end datepicker inputdatepicker" data-id="pay_end" @if ($invoice->pay_end != '') value="{{ $invoice->pay_end ?? ''}}" @else value="<?php echo date('m/d/Y'); ?>" @endif>
                                </div>
                            ...
                            <div class="col-md-3 mt-4">
                                <div>
                                    ...
                                    <input style="color:#140303f5;padding:0px 6px !important; height:40px; appearance: none; border:1px solid #110303fe;" type="text" id="pay_date" name="pay_date" placeholder="12-19-2022" class="w-100 p-2 input-box-font removeDiv pay_date datepicker inputdatepicker" data-id="pay_date" @if ($invoice->pay_date != '') value="{{ $invoice->pay_date }}" @else value="<?php echo date('m/d/Y'); ?>" @endif>
                                </div>
                        ...
                        <div class="row ">
                            <div class=" col-lg-2 col-md-2 margin-bottom  mt-2">
                                ...
                                <div class="margin-bottom mb-3" id="earningusa_{{$key}}00">
                                    <input class="earnbtn {{ $key == 0 ? 'mt-4' : '' }} text-center earnbtn_0" type="text" name="earning[]" value="{{ $earning ?? null }}" id="earning_00{{ $key }}" data-id="00{{ $key }}">
                                </div>
                                @endforeach
                            ...
                            <div class="col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3" id="rateusa_{{$key}}00">
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3" id="hoursusa_{{$key}}00">
                            ...
                            <div class=" col-lg-2 col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3" id="totalusa_{{$key}}00">
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2">
                                ...
                                <div class="margin-bottom mb-3" style="padding-top: {{ $key == 0 ? '2px' : '' }}" id="periodusa_{{$key}}00">
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom mb-3" style="padding-top: {{ $key == 0 ? '2px' : '' }}" id="removebtn_usa{{$key}}00">
                                    <input type="text" name="ytd_total[]" class="earnbtn  text-center ytd_total" value="{{ $ytd_total ?? null }}" id="ytd_total_00{{ $key }}" data-id="00{{ $key }}">
                                    @if($key >0)
                                    <button type="button" class="cross-btn-canadas removebtn-usa r-25" data-ref="{{ $key }}00" data-id="{{ $key }}">
                                        <span>x</span></button>
                                    @endif
                                </div>
                                @endforeach
                        ...
                        <div class="row mb-3">
                            <div class="col-xl-2 col-lg-3 col-md-4 mt-2 margin-bottom">
                                <button type="button" class="add_button earnbtn" type="add_earning" id="add_earning" style="font-size: 18px"><i class="fa fa-plus-circle pr-2" style="font-size:24px;color:green"></i>Add Earning</button>
                            </div>
                        </div>
                        ...
                        <div class="mt-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-lg-2 mb-3">
                                    <input type="text" name="taxes_rate[]" value="{{ $invoice->taxes_rate[$key] ?? 0 }}" class="earnbtn text-center manualTaxTotal taxes_{{ $item->title }}" id="taxes_00{{ $key }}" readonly />
                                </div>
                                <div class="col-md-2 col-lg-2 mb-3">
                                    <input type="text" name="taxes_ytd[]" value="{{ $invoice->taxes_ytd[$key] ?? 0 }}" class="earnbtn text-center manualTaxTotal taxes_{{ $item->title }}" id="taxes_ytd_00{{ $key }}" readonly />
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="my-3">
                            <div class="row my-3">
                                <div class="col-md-4 col-lg-3">
                                    <button type="button" class="add_deduction earnbtn" type="add_deduction" style="font-size: 18px !important;"><i class="fa fa-plus-circle pr-5" style="font-size:24px;color:green"></i>Add Deduction</button>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <input type="text" name="deduction_tax" value="{{ $invoice->deduction_tax ?? '' }}" class="earnbtn deduction_tax text-center" />
                                </div>
                                <div class="col-md-2 mb-2">
                                    <p class="p-0 m-0 text-center" style="font-family: serif;">YTD Gross</p>
                                    <input type="text" name="ytd_deduction_tax" value="{{ $invoice->ytd_deduction_tax ?? '' }}" class="earnbtn ytd_deduction_tax text-center" />
                                </div>
                            </div>
                            <div class="row mb-3 mt-5">
                                ...
                                <div class="col-md-2 mb-2">
                                    ...
                                    <input name="total_net_pay" value="{{ $invoice->total_net_pay ?? '' }}" class="earnbtn text-center total_net_pay">
                                </div>
                                <div class="col-md-2 mb-2">
                                    <p class="p-0 m-0 text-center" style="font-family: serif;">YTD Net pay</p>
                                    <input name="total_ytd_net_pay" value="{{ $invoice->total_ytd_net_pay ?? '' }}" class="earnbtn text-center total_ytd_net_pay">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4 col-md-4 col-sm-6 mb-2 advicex advicexv d-none">
                                    <div>
                                        ...
                                        <input type="text" name="co_number" id="co_number" value="{{ $invoice->co_number ?? '' }}" class="earnbtn removeDiv text-center" maxlength="4" minlength="4" style="text-transform:uppercase" placeholder="MP5">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-6 mb-2 advicex advicexv d-none">
                                    <div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 mb-2 advicex advicexv d-none">
                                    <div>
                                        ...
                                        <input type="text" name="file_number" id="file_number" value="{{ $invoice->file_number ?? '' }}" class="earnbtn removeDiv text-center" maxlength="6" minlength="4" placeholder="123456" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                    </div>
                                </div>
