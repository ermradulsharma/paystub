                            ...
                            <div class="col-md-5 col-lg-6 col-sm-12 mt-5  text-center">
                                ...
                                <div class="mt-4">
                                    <div class="input-group mmenu mb-3 text-center">
                                        <select name="basic_temp" value="{{$invoice->basic_temp ?? ''}}" class="form-control text-center bt_id small-font basicTemplate" style="margin-right:10px; font-size:18px;">
                            ...
                            <div class="col-md-5 col-lg-6 col-sm-12 mt-5 text-center">
                                ...
                                <div class="mt-4">
                                    <div class="input-group mmenu mb-3">
                                        <select name="advance_temp" class="form-control text-center at_id small-font advanceTemplate" style="margin-right:10px; font-size:18px;">
                    ...
                    <div class=" box-usa">
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mt-4">
                                ...
                                <div class="text-center mt-2  d-flex justify-content-center">
                                    <button type="button" class="hour_btn date_select">HOURLY</button> <button type="button" class="salary_btn">SALARY</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2">
                                ...
                                <div class="margin-bottom" style="padding-top: {{$key==0 ? '2px' : ''}}">
                                    <input type="text" name="period[]" class="earnbtn mb-3  text-center gross_total" value="{{$period ?? null}}" id="period_00{{$key}}" data-id="00{{$key}}">
                                </div>
                                @endforeach
                            ...
                            <div class=" col-lg-2  col-md-2 margin-bottom mt-2  ">
                                ...
                                <div class="margin-bottom" style="padding-top: {{$key==0 ? '2px' : ''}}">
                                    <input type="text" name="ytd_total[]" class="earnbtn mb-3  text-center ytd_total" value="{{$ytd_total ?? null}}" id="ytd_total_00{{$key}}" data-id="00{{$key}}">
                                </div>
                                @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <p class="p-0 m-0 text-left font-weight-bold" style="font-family: serif;">Tap on padlock to change text</p>
                            </div>
                        </div>
                        <div class="mt-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-lg-2 mb-3">
                                    <input type="text" name="taxes_rate[]" value="{{$invoice->taxes_rate[$key] ?? 0}}" class="earnbtn text-center manualTaxTotal" id="taxes_00{{ $key }}" />
                                </div>
                                <div class="col-md-2 col-lg-2 mb-3">
                                    <input type="text" name="taxes_ytd[]" value="{{$invoice->taxes_ytd[$key] ?? 0}}" class="earnbtn text-center manualTaxTotal" id="taxes_ytd_00{{ $key }}" />
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-3 mb-3"><img src="{{ asset('images/lock.png') }}" class="earnbtn2"><input name="tax_deduction[]" value="{{$tax_deduction ?? ''}}" class="earnbtn text-center tax_deduction_00{{$key+1}} tax_deduction_00{{$key+1}} " data-id="00{{$key+1}}" type="text"></div>
                                <div class="col-md-1 col-lg-1"></div>
                                <div class="col-md-2 col-lg-3"></div>
                                <div class="col-md-1 col-lg-1"></div>
                                <div class="col-md-2 col-lg-2 mb-3"><input type="text" name="period_tax_deduction[]" value="{{$invoice->period_tax_deduction[$key] ?? 0}}" class="earnbtn text-center tax_deduction tax" id="taxes_00{{$key+1}}" data-id="00{{$key+1}}"></div>
                                <div class="col-md-2 col-lg-2 mb-3"><input type="text" name="ytd_tax_deduction[]" value="{{$invoice->ytd_tax_deduction[$key] ?? 0}}" class="earnbtn text-center ytd_tax tax add_ytd_deduction" id="taxes_ytd_00{{$key+1}}" data-id="00{{$key+1}}"></div>
                            </div>
                            @endforeach
