            ...
            <table class="table text-center" style="border:3px solid #FF6161; border-style: inset;background:#E8E6E6;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th class="text-center" style="padding: .9em 1em;border:none;">
                        ...
                        <th class="text-center" style="padding: 1em 1em;border:none;">
                        ...
                        <th class="text-center" style="padding: 1.5em 1em;border:none;">
                            <a class="delbtn" style="margin-top:.5em;" href="javascript:void(0);" onclick="event.preventDefault();if(confirm('Are you sure! you want to delete this?')){document.getElementById('delete-form-{{$invoice->id}}').submit();}"> Delete <i class="fa fa-trash"></i></a>
                            <form id="delete-form-{{$invoice->id}}" action="{{ route('invoiceDelete', $invoice->id) }}" method="POST" style="display: none;">
                                {{csrf_field()}}
                            </form>
                        </th>
                        <th class="text-center" style="padding: 1.5em 1em;border:none;">
                            <a href="javascript:void(0);" class="previewbtn text-capitalize">Preview Your Paystub <i class="fa fa-eye"></i></a>
                        </th>
                    </tr>
                    @endforeach
                </tbody>
