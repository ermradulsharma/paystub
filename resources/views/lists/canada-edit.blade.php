                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="input-group mmenu mb-3" style="margin: auto;">
                                        <select name="advance_temp" class="form-control text-center dropdown1 at_id small-font advanceTemplate" style="margin-right:10px; font-size:18px;">
                                            ...
                                            <option value="{{$data->title}}" data-src="{{$data->images->file}}" {{$invoice->advance_temp == $data->title ? 'selected' : ''}}>{{$data->name}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mt-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_id" name="emp_id" value="{{$invoice->emp_id ?? ''}}" placeholder="Employee id" class="w-100 p-2  textInputFontSize">
                                </div>
                            </div>
                            ...
                            <div class="col-md-2 mt-4 pr-0">
                                <div>
                                    ...
                                    <input type="date" id="pay_start" name="pay_start" value="{{$invoice->pay_start ?? ''}}" placeholder="12-11-2022" class="w-100 p-2 textInputFontSize pay_start datepicker" data-id="pay_start" style="border-right: none;">
                                </div>
                            </div>
                            <div class="col-md-2 mt-4 pl-0">
                                <div>
                                    <label for="emp_id" class="lable"> <span class="redColor">*</span></label>
                                    <input type="date" id="pay_end" name="pay_end" value="{{$invoice->pay_end ?? ''}}" placeholder=" " class="w-100 p-2 textInputFontSize pay_end" data-id="pay_end" style="border-left: none;" readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mt-4">
                                <div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <input type="text" id="check_number" name="check_number" value="{{$invoice->check_number ?? ''}}" placeholder="Check Number" class="w-100 p-2  textInputFontSize">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div>
                                    ...
                                    <input type="text" id="emp_name" name="emp_name" value="{{$invoice->emp_name ?? ''}}" placeholder="Employee name" class="w-100 p-2  textInputFontSize">
                                </div>
                            ...
                            <div class="col-md-8">
                                <div>
                                    ...
                                    <input type="text" id="emp_address" name="emp_address" value="{{$invoice->emp_address ?? ''}}" placeholder="Suite 101 or Apt 101(optional)" class="w-100 p-2  textInputFontSize">
                                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class=" box-usa">
                            ...
                            <div class="col-lg-5 p-0 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 pr-0 mt-4">
                                        <input class="earnbtn text-center" readonly name="taxes_rate[]" id="tax_total_00{{ $key }}" value="{{ $invoice->taxes_rate[$key] ?? null }}">
                                    </div>

                                    <div class="col-lg-4 pr-0 mt-4">
                                        <input class="earnbtn text-center" readonly name="taxes_ytd[]" id="tax_ytd_00{{ $key }}" value="{{ $invoice->taxes_ytd[$key] ?? null }}">
                                    </div>
                                </div>
                                @endforeach
                                <div id="appendTaxField">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 pr-0 mt-4">
                                            <input class="earnbtn text-center deduction_other" name="period_tax_deduction[]" value="{{$invoice->period_tax_deduction[$key]}}" id="tax_00{{$key}}">
                                        </div>

                                        <div class="col-lg-4 pr-0 mt-4">
                                            <input class="earnbtn text-center deduction_other_ytd" name="ytd_tax_deduction[]" value="{{$invoice->ytd_tax_deduction[$key]}}" id="ytd_00{{$key}}">
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-2">
                                <input CLASS="earnbtn text-center" id="ytd_gross" readonly name="ytd_gross_total" value="{{$invoice->ytd_gross_total ?? ''}}">
                            </div>
                            <div class="col-md-2">
                                <input CLASS="earnbtn text-center" id="ytd_deducations" readonly name="ytd_deduction_tax" value="{{$invoice->ytd_deduction_tax ?? ''}}">
                            </div>
                            <div class="col-md-2">
                                <input CLASS="earnbtn text-center" id="ytd_net_pay" readonly name="total_ytd_net_pay" value="{{$invoice->total_ytd_net_pay ?? ''}}">
                            </div>
                            <div class="col-md-2">
                                <input CLASS="earnbtn text-center" id="current_total" readonly name="period_gross_total" value="{{$invoice->period_gross_total ?? ''}}">
                            </div>
                            <div class="col-md-2">
                                <input CLASS="earnbtn text-center" id="deductions" readonly name="deduction_tax" value="{{$invoice->deduction_tax ?? ''}}">
                            </div>
                            <div class="col-md-2">
                                <input CLASS="earnbtn text-center" id="net_pay" readonly name="total_net_pay" value="{{$invoice->total_net_pay ?? ''}}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="mb- d-flex" style="justify-content: space-between;">
                        ...
                        <div class="text-right mt-1 ">
                            <button type="button" class="emailbtn sendMailButton" data-toggle="modal" data-target="#myModal"> <i class="fa fa-envelope mr-4" style="font-size:24px"></i>EMAIL
