                                    ...
                                    <div class="row">
                                        <div class=" col-lg-4 col-md-12 margin-bottom  mt-2  px-lg-2 px-0 addincomeKey">
                                            ...
                                            <div class="margin-bottom">
                                                ...
                                                <input class="earnbtn mt-3 text-center incomeKey" data-id="000" name="earning[]" id="incomeKey_{{ $key }}11" type="text" value="{{ $earning }}">
                                                @endforeach
                                            </div>
                                        ...
                                        <div class=" col-lg-4 col-md-12 margin-bottom  mt-2  px-lg-2 px-0 addrateKey">
                                            ...
                                            <div class="margin-bottom">
                                                ...
                                                <input class="earnbtn mt-3 text-center rateKey" type="number" id="rate_000{{ $key }}11" name="rate[]" type="text" value="{{ $rate }}">
                                                @endforeach
                                            </div>
                                            <div id="addEarning"></div>
                                        </div>
                                        <div class=" col-lg-4 col-md-12 margin-bottom  mt-2  px-lg-2 px-0 addhoursKey">
                                            ...
                                            <div class="margin-bottom">
                                                ...
                                                <input class="earnbtn mt-3 text-center hoursKey" type="number" id="hours_000{{ $key }}11" name="hours[]" type="text" value="{{ $hours }}">
                                                @if($key > 0)
                                                <button type="button" class="cross-btn-uks removebtn-uk" data-ref="{{$key}}11" id="removebtn{{ $key }}11">
                                                    <span>x</span></button>
                                                @endif
                                                @endforeach
                                            </div>
                                        ...
                                        <div class=" col-lg-4 col-md-12 margin-bottom  mt-2  px-lg-2 px-0 addcurrentTotal" hidden>
                                            ...
                                            <div class="margin-bottom">
                                                ...
                                                <input class="earnbtn mt-3 text-center currentTotal" type="number" id="total_000{{ $key }}11" name="total[]" type="text" value="{{ $total }}">
                                                @endforeach
                                            </div>
                                            <div id="addEarning"></div>
                                        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key={{ env('GOOGLE_MAPS_API_KEY', 'AIzaSyAOVYRIgupAurZup5y1PRh8Ismb1A3lLao') }}">
</script>
<script>
