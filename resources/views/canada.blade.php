@extends('layouts.app')
@section('content')
    <div style="background-color: #f75656ed; padding:30px 0px;" class="mt-2">
            ...
            <div class="row" style="margin:0 auto;">
                <div class="col-lg-4  text-center2">
                    ...
                    <div class="mt-5 pt-2 justify-content-center">
                        <a href="https://apps.apple.com/us/app/paystubx-paystub-maker/id1658931100" target="_blank"><img
                                class="storbtn" src="{{ asset('images/Download_on_the_App_Store_Badge.webp') }}"></a>
                        <a href="https://play.google.com/store/apps/details?id=com.paystubx" target="_blank"><img
                                class="storbtn ml-2" src="{{ asset('images/Google_Play_Store_badge_EN.webp') }}"></a>
                    </div>
                </div>

                <div class="col-lg-8" style=" margin:auto;">
                    <div class="computer-img"><img src="{{ asset('images/computer.png') }}" class="w-100"></div>
        ...
        <div class="container" style="max-width: 1580px;">
            <div class="row" style="margin:0 auto;">
                <div class="col-md-6 col-sm-6 justifuy-content-center">
                    ...
                    <p class="paragraph"
                        style=" font-size: 22px; font-weight: 200;line-height: 30px; font-family: 'Futura LT';">Very easy
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 m-auto justify-content-center" style="">
    ...
    <div class="container-fluid pb-5 d-flex " style="background-image: linear-gradient(45deg, #fdf5f4, #f2fbf7);">
        <a class="btn btn-lg  mt-5 p-2 btn-danger Generate canada-btn " href="{{ route('canada.payStub') }}">Generate
            Paystub Now</a>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-12 text-center mt-3 code">
                ...
                <div class="my-5">
                    <a href="https://apps.apple.com/us/app/paystubx-paystub-maker/id1658931100" target="_blank"><img
                            class="storbtn" src="{{ asset('images/Download_on_the_App_Store_Badge.webp') }}"></a>
                    <a href="https://play.google.com/store/apps/details?id=com.paystubx" target="_blank"><img
                            class="storbtn ml-5" src="{{ asset('images/Google_Play_Store_badge_EN.webp') }}"></a>
                </div>
