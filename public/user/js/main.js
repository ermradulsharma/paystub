...
function checkValidationForm() {
    ...
    $.each(formData, function (i, element) {
        ...
        var blockedTile = new Array('address_2', 'emp_street_2', 'hourly', 'earning', 'rate',
        ...
        if (blockedTile.indexOf(name) == -1 && element.value.length == 0) {
            ...
            $('#' + name).parent().parent().children("div").append(
                "<div class='text-danger error_div 0_" + name +
    ...
    $.ajax({
        ...
        error: function (err) {
            ...
            error.errors.forEach((element, i) => {
                ...
                $('#' + element.key).parent().parent().children("div").append(
                    '<div class="text-danger error_div 0_' + element.key + '">' + element
                        .message + '</div>');
            });
            document.getElementById("loaderDiv").style.display = "none";
        }
