...
class TemplateFormController extends Controller
{
    ...
    public function   basicCerulean1()
    {
        $data = [
            'date' => date('m/d/Y')
        ];
        //    return view('allForms.cerulean1');
        $pdf = PDF::loadView('allForms.cerulean1', $data);
        return $pdf->setPaper('A4')->stream('Cerulean1Paystubx.pdf');
    }
    public function    basicStone()
    {
        $data = [
            'date' => date('m/d/Y')
        ];
        //    return view('allForms.stone');
        $pdf = PDF::loadView('allForms.stone', $data);
        return $pdf->setPaper('A4')->stream('StonePaystubx.pdf');
    }
    public function    basicPaystubx_blue_fiot_d()
    {
        $data = [
            'date' => date('m/d/Y')
        ];
        //    return view('allForms.paystubx_blue_fiot_d');
        $pdf = PDF::loadView('allForms.paystubx_blue_fiot_d', $data);
        return $pdf->setPaper('A4')->stream('Paystubx_blue_fiot_dPaystubx.pdf');
    }
    public function    basicJam()
    {
        $data = [
            'date' => date('m/d/Y')
        ];
        //    return view('allForms.jam');
        $pdf = PDF::loadView('allForms.jam', $data);
        return $pdf->setPaper('A4')->stream('JamPaystubx.pdf');
    }
    public function    basicFog()
    {
        $data = [
            'date' => date('m/d/Y')
        ];
        //    return view('allForms.Fog');
        $pdf = PDF::loadView('allForms.Fog', $data);
        return $pdf->setPaper('A4')->stream('FogPaystubx.pdf');
    }
    public function    basicEmerald()
    {
        $data = [
            'date' => date('m/d/Y')
        ];
        //    return view('allForms.emerald');
        $pdf = PDF::loadView('allForms.emerald', $data);
        return $pdf->setPaper('A4')->stream('EmeraldPaystubx.pdf');
    }
